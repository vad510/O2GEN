...
/*eslint-disable*/
/*jshint ignore:start*/
(function(){function na(h,m){h.prototype=cb(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function cb(h){function m(){}m.prototype=h;return new m}function Wa(h,m,w){"millisecond"===w?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===w?h.setSeconds(h.getSeconds()+1*m):"minute"===w?h.setMinutes(h.getMinutes()+1*m):"hour"===w?h.setHours(h.getHours()+1*m):"day"===w?h.setDate(h.getDate()+1*m):"week"===w?h.setDate(h.getDate()+7*m):"month"===w?h.setMonth(h.getMonth()+1*m):"year"===w&&h.setFullYear(h.getFullYear()+
1*m);return h}function X(h,m){var w=!1;0>h&&(w=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return w?"-"+h:h}function Ea(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,w=h.length;m.test(h.charAt(--w)););return h.slice(0,w+1)}function Aa(h){h.roundRect=function(h,w,s,u,oa,D,x,E){x&&(this.fillStyle=x);E&&(this.strokeStyle=E);"undefined"===typeof oa&&(oa=5);this.lineWidth=D;this.beginPath();this.moveTo(h+oa,w);this.lineTo(h+s-oa,w);this.quadraticCurveTo(h+s,w,h+s,w+oa);this.lineTo(h+s,
w+u-oa);this.quadraticCurveTo(h+s,w+u,h+s-oa,w+u);this.lineTo(h+oa,w+u);this.quadraticCurveTo(h,w+u,h,w+u-oa);this.lineTo(h,w+oa);this.quadraticCurveTo(h,w,h+oa,w);this.closePath();x&&this.fill();E&&0<D&&this.stroke()}}function Qa(h,m){return h-m}function R(h){var m=((h&16711680)>>16).toString(16),w=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;w=2>w.length?"0"+w:w;h=2>h.length?"0"+h:h;return"#"+m+w+h}function db(h,m){var w=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=w);s<w;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Ba(h){h.indexOf||(h.indexOf=db);return h}function eb(h){if(Fa.fSDec)h[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){Fa._fTWm&&Fa._fTWm(h)})}function Xa(h,m,w){w=w||"normal";var s=h+"_"+m+"_"+w,u=Ya[s];if(isNaN(u)){try{h="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
h+"; font-size:"+m+"px; font-weight:"+w+";";if(!pa){var oa=document.body;pa=document.createElement("span");pa.innerHTML="";var D=document.createTextNode("Mpgyi");pa.appendChild(D);oa.appendChild(pa)}pa.style.display="";pa.setAttribute("style",h);u=Math.round(pa.offsetHeight);pa.style.display="none"}catch(x){u=Math.ceil(1.1*m)}u=Math.max(u,m);Ya[s]=u}return u}function N(h,m){var w=[];if(w={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<w.length;s++)w[s]*=m;else w=[];return w}function J(h,m,w,u,sa){u=u||[];sa=s(sa)?fb?{passive:!1,capture:!1}:!1:sa;u.push([h,m,w,sa]);return h.addEventListener?(h.addEventListener(m,w,sa),w):h.attachEvent?(u=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};w.call(h,m)},h.attachEvent("on"+
m,u),u):!1}function gb(h){if(h._menuButton)h.exportEnabled?(fa(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),Ka(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):ta(h._menuButton);else if(h.exportEnabled&&u){var m=!1;h._menuButton=document.createElement("button");ua(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);J(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);J(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||
h._dropDownCloseTime&&500>=(new Date).getTime()-h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);J(h._menuButton,"mouseover",function(){m||(fa(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&fa(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);J(h._menuButton,
"mouseout",function(){m||(fa(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&fa(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(h.exportEnabled&&h._dropdownMenu){fa(h._dropdownMenu,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor});for(var w=h._dropdownMenu.childNodes,s=[h._cultureInfo.printText,h._cultureInfo.saveJPGText,h._cultureInfo.savePNGText],
sa=0;sa<w.length;sa++)fa(w[sa],{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),w[sa].innerHTML=s[sa]}else!h._dropdownMenu&&(h.exportEnabled&&u)&&(m=!1,h._dropdownMenu=document.createElement("div"),h._dropdownMenu.setAttribute("tabindex",-1),w=-1!==h.theme.indexOf("dark")?"black":"#888888",h._dropdownMenu.style.cssText="position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:"+
...
h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),J(w,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),J(w,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Za(h,m,w){h*=ja;m*=ja;h=w.getImageData(h,m,2,2).data;m=!0;for(w=0;4>w;w++)if(h[w]!==h[w+4]|h[w]!==h[w+8]|
h[w]!==h[w+12]){m=!1;break}return m?h[0]<<16|h[1]<<8|h[2]:0}function ka(h,m,w){return h in m?m[h]:w[h]}function La(h,m,w){if(u&&$a){var s=h.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ja=Ra/Ma;h.width=m*ja;h.height=w*ja;Ra!==Ma&&(h.style.width=m+"px",h.style.height=w+"px",s.scale(ja,ja))}else h.width=m,h.height=w}function hb(h){if(!ib){var m=!1,w=!1;"undefined"===typeof wa.Chart.creditHref?
(h.creditHref=Y("iuuqr;..b`ow`rkr/bnl."),h.creditText=Y("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),w=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),h._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(h.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
...
var w=document.createElement("canvas");w.setAttribute("class","canvasjs-chart-canvas");La(w,h,m);u||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(w);return w}function fa(h,m){for(var w in m)h.style[w]=m[w]}function ua(h,m,w){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",fa(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
w&&(m.setAttribute("state",w),m.setAttribute("type","button"),fa(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[w+"Text"]),m.innerHTML="<img style='height:95%; pointer-events: none;' src='"+jb[w].image+"' alt='"+h._cultureInfo[w+"Text"]+"' />")}function Ka(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function ta(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Sa(h,m,w,s,u){if(null===h||"undefined"===typeof h)return"undefined"===typeof w?m:w;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof s&&(h=Math.min(s,h),"undefined"!==typeof u&&(h=Math.max(u,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof w?m:w}function I(h,m,w,u,x){this._defaultsKey=h;this._themeOptionsKey=m;this._index=u;this.parent=x;this._eventListeners=[];
h={};this.theme&&s(this.parent)&&s(m)&&s(u)?h=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[m])&&(null===u?h=this.parent.themeOptions[m]:0<this.parent.themeOptions[m].length&&(u=Math.min(this.parent.themeOptions[m].length-1,u),h=this.parent.themeOptions[m][u]));this.themeOptions=h;this.options=w?w:{_isPlaceholder:!0};this.setOptions(this.options,h)}function Ca(h,m,w,s,u){"undefined"===
typeof u&&(u=0);this._padding=u;this._x1=h;this._y1=m;this._x2=w;this._y2=s;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ha(h,m){ha.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ta(h,m){Ta.base.constructor.call(this,"Toolbar","toolbar",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function xa(h,m){xa.base.constructor.call(this,
...
[]}function Ia(h){var m;h&&Ja[h]&&(m=Ja[h]);Ia.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ga=!1,Fa={},u=!!document.createElement("canvas").getContext,wa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
Ja={en:{}},x=u?"Trebuchet MS, Helvetica, sans-serif":"Arial",Da=u?"Impact, Charcoal, sans-serif":"Arial",ya={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},
K,Z,T,ca,ga;Z="#333333";T="#000000";K="#666666";ga=ca="#000000";var V=20,E=14,Va={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Da,fontSize:32,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Da,fontSize:E,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:Z,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:Z,
titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,
labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,
labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],
legend:{fontFamily:x,fontSize:14,fontColor:Z,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};T=Z="#F5F5F5";K="#FFFFFF";ca="#40BAF1";ga="#F5F5F5";var V=20,E=14,ab={colorSet:"colorSet2",title:{fontFamily:x,fontSize:33,fontColor:"#3A3A3A",
fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:E,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",
tickThickness:1,tickColor:"#BBBBBB",gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,
titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",
labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:E,
labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,
labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",
...
V=20;E=14;Da={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Da,fontSize:32,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Da,fontSize:E,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:T,
indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",
labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",
lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],
axisY2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,
color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:x,fontSize:14,fontColor:Z,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:T,backgroundColor:"rgba(0, 0, 0, .7)"}};K="#FFFFFF";T=Z="#FAFAFA";ca="#40BAF1";ga="#F5F5F5";var V=20,E=14,bb={light1:Va,light2:ab,dark1:Da,
dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:x,fontSize:32,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:E,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:T,indexLabelFontWeight:"normal",
indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",
labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",
labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:0,
lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,
titleFontSize:V,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:T,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,
...
hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")},fb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(w){h=!1}return h}(),Ya={},pa=null,kb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&
...
u="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),x=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,D=/[^-+\dA-Z]/g;return function(E,N,P){var K=P?P.days:m,R=P?P.months:s,J=P?P.shortDays:w,U=P?P.shortMonths:u;P="";var I=!1;E=E&&E.getTime?E:E?new Date(E):new Date;if(isNaN(E))throw SyntaxError("invalid date");"UTC:"===N.slice(0,4)&&(N=N.slice(4),I=!0);P=I?"getUTC":"get";var T=E[P+"Date"](),M=E[P+"Day"](),
W=E[P+"Month"](),a=E[P+"FullYear"](),d=E[P+"Hours"](),c=E[P+"Minutes"](),b=E[P+"Seconds"](),e=E[P+"Milliseconds"](),f=I?0:E.getTimezoneOffset();return P=N.replace(h,function(l){switch(l){case "D":return T;case "DD":return X(T,2);case "DDD":return J[M];case "DDDD":return K[M];case "M":return W+1;case "MM":return X(W+1,2);case "MMM":return U[W];case "MMMM":return R[W];case "Y":return parseInt(String(a).slice(-2));case "YY":return X(String(a).slice(-2),2);case "YYY":return X(String(a).slice(-3),3);case "YYYY":return X(a,
4);case "h":return d%12||12;case "hh":return X(d%12||12,2);case "H":return d;case "HH":return X(d,2);case "m":return c;case "mm":return X(c,2);case "s":return b;case "ss":return X(b,2);case "f":return X(String(e),3).slice(0,1);case "ff":return X(String(e),3).slice(0,2);case "fff":return X(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return I?"UTC":(String(E).match(x)||[""]).pop().replace(D,
"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2)+X(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),da=function(h,m,w){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var u=w?w.decimalSeparator:".",x=w?w.digitGroupSeparator:",",D="";m=String(m);var D=1,E=w="",N=-1,P=[],K=[],R=0,J=0,U=0,I=!1,T=0,E=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
m=null;for(var M=0;E&&M<E.length;M++)if(m=E[M],"."===m&&0>N)N=M;else{if("%"===m)D*=100;else if("\u2030"===m){D*=1E3;continue}else if(","===m[0]&&"."===m[m.length-1]){D/=Math.pow(1E3,m.length-1);N=M+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(I=!0);0>N?(P.push(m),"#"===m||"0"===m?R++:","===m&&U++):(K.push(m),"#"!==m&&"0"!==m||J++)}I&&(m=Math.floor(h),E=-Math.floor(Math.log(h)/Math.LN10+1),T=0===h?0:0===m?-(R+E):String(m).length-R,D/=Math.pow(10,T));0>N&&(N=M);D=(h*D).toFixed(J);
m=D.split(".");D=(m[0]+"").split("");h=(m[1]+"").split("");D&&"0"===D[0]&&D.shift();for(I=E=M=J=N=0;0<P.length;)if(m=P.pop(),"#"===m||"0"===m)if(N++,N===R){var W=D,D=[];if("0"===m)for(m=R-J-(W?W.length:0);0<m;)W.unshift("0"),m--;for(;0<W.length;)w=W.pop()+w,I++,0===I%E&&(M===U&&0<W.length)&&(w=x+w)}else 0<D.length?(w=D.pop()+w,J++,I++):"0"===m&&(w="0"+w,J++,I++),0===I%E&&(M===U&&0<D.length)&&(w=x+w);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(M++,E=I,I=0,0<D.length&&
(w=x+w)):w=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+w:m+w:(m=0>T?m.replace("+","").replace("-",""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return X(T,a.length)}));x="";for(P=!1;0<K.length;)m=K.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(x+=h.shift(),P=!0):"0"===m&&(x+="0",P=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?x+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-
1]||!/[eE][+-]*[0]+/.test(m)?x+=m:(m=0>T?m.replace("+","").replace("-",""):m.replace("-",""),x+=m.replace(/[0]+/,function(a){return X(T,a.length)}));w+=(P?u:"")+x;return s?"-"+w:w},Na=function(h){var m=0,w=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,w=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,w=h.layerY):(m=h.pageX-h.target.offsetLeft,w=h.pageY-h.target.offsetTop);return{x:m,y:w}},$a=!0,Ra=window.devicePixelRatio||1,Ma=1,ja=$a?Ra/Ma:1,ba=function(h,m,w,s,u,x,D,E,N,P,R,K,J){"undefined"===
typeof J&&(J=1);D=D||0;E=E||"black";var I=15<s-m&&15<u-w?8:0.35*Math.min(s-m,u-w);h.beginPath();h.moveTo(m,w);h.save();h.fillStyle=x;h.globalAlpha=J;h.fillRect(m,w,s-m,u-w);h.globalAlpha=1;0<D&&(J=0===D%2?0:0.5,h.beginPath(),h.lineWidth=D,h.strokeStyle=E,h.moveTo(m,w),h.rect(m-J,w-J,s-m+2*J,u-w+2*J),h.stroke());h.restore();!0===N&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+I,w+I),h.lineTo(s-I,w+I),h.lineTo(s,w),h.closePath(),D=h.createLinearGradient((s+m)/2,w+I,(s+m)/2,w),D.addColorStop(0,x),
D.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=D,h.fill(),h.restore());!0===P&&(h.save(),h.beginPath(),h.moveTo(m,u),h.lineTo(m+I,u-I),h.lineTo(s-I,u-I),h.lineTo(s,u),h.closePath(),D=h.createLinearGradient((s+m)/2,u-I,(s+m)/2,u),D.addColorStop(0,x),D.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=D,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+I,w+I),h.lineTo(m+I,u-I),h.lineTo(m,u),h.closePath(),D=h.createLinearGradient(m+I,(u+w)/2,m,(u+w)/2),D.addColorStop(0,
x),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=D,h.fill(),h.restore());!0===K&&(h.save(),h.beginPath(),h.moveTo(s,w),h.lineTo(s-I,w+I),h.lineTo(s-I,u-I),h.lineTo(s,u),D=h.createLinearGradient(s-I,(u+w)/2,s,(u+w)/2),D.addColorStop(0,x),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=D,D.addColorStop(0,x),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=D,h.fill(),h.closePath(),h.restore())},Y=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/
57/5)^h.charCodeAt(s));return m},ib=window&&(window[Y("mnb`uhno")]&&window[Y("mnb`uhno")].href&&window[Y("mnb`uhno")].href.indexOf&&(-1!==window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl"))||-1!==window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl"))||-1!==window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))))&&-1===window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),jb={reset:{image:"data:image/png;base64,"},
...
m=s):m=void 0,h[m]=this.options};I.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Ba(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};I.prototype.updateOption=function(h){!wa[this._defaultsKey]&&(Ga&&window.console)&&console.log("defaults not set");var m=wa[this._defaultsKey],u={},x=this[h],E=this._themeOptionsKey,
I=this._index;this.theme&&s(this.parent)&&s(E)&&s(I)?u=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[E])&&(null===I?u=this.parent.themeOptions[E]:0<this.parent.themeOptions[E].length&&(u=Math.min(this.parent.themeOptions[E].length-1,I),u=this.parent.themeOptions[E][u]));this.themeOptions=u;h in m&&(x=h in this.options?this.options[h]:u&&h in u?u[h]:m[h]);if(x===this[h])return!1;this[h]=
...
this.measureText(this.ctx);this.ctx.translate(this.x,this.y+s);"middle"===this.textBaseline&&(s=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var u=0,x=this.topPadding,E=null;this.ctx.roundRect||Aa(this.ctx);(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,s,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(s=0;s<this._wrappedText.lines.length;s++){E=
this._wrappedText.lines[s];if("right"===this.horizontalAlign||"right"===this.textAlign)u=this.width-E.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)u=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)u=(this.width-(this.leftPadding+this.rightPadding))/2-E.width/2+this.leftPadding;this.ctx.fillText(E.text,u,x);x+=E.height}this.ctx.font=m;h&&this.ctx.restore()}};ha.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
null};ha.prototype.measureText=function(){this._lineHeight=Xa(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ha.prototype._getLineWithWidth=function(h,m,s){h=String(h);if(!h)return{text:"",width:0};var u=s=0,x=h.length-1,E=Infinity;for(this.ctx.font=this._getFontString();u<=x;){var E=Math.floor((u+x)/2),D=h.substr(0,E+1);s=this.ctx.measureText(D).width;
if(s<m)u=E+1;else if(s>m)x=E-1;else break}s>m&&1<D.length&&(D=D.substr(0,D.length-1),s=this.ctx.measureText(D).width);m=!0;if(D.length===h.length||" "===h[D.length])m=!1;m&&(h=D.split(" "),1<h.length&&h.pop(),D=h.join(" "),s=this.ctx.measureText(D).width);return{text:D,width:s}};ha.prototype._wrapText=function(){var h=new String(Ea(String(this.text))),m=[],s=this.ctx.font,u=0,x=0;this.ctx.font=this._getFontString();if(0===this.frontSize)x=u=0;else for(;0<h.length;){var E=this.maxHeight-(this.topPadding+
this.bottomPadding),D=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);D.height=this._lineHeight;m.push(D);var I=x,x=Math.max(x,D.width),u=u+D.height,h=Ea(h.slice(D.text.length,h.length));E&&u>E&&(D=m.pop(),u-=D.height,x=I)}this._wrappedText={lines:m,width:x,height:u};this.width=x+(this.leftPadding+this.rightPadding);this.height=u+(this.topPadding+this.bottomPadding);this.ctx.font=s};ha.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!u&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};na(Ta,I);na(xa,I);xa.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),u=m.x1,x=m.y1,E=0,I=0,D=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,J;"top"===this.verticalAlign||
...
backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:I,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"});P=I.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(x=m.y1+2,J="top"):"bottom"===this.verticalAlign&&(x=m.y2-2-P.height,J="bottom"),"left"===this.horizontalAlign?u=m.x1+2:"center"===this.horizontalAlign?u=m.x1+m.width/2-P.width/2:"right"===this.horizontalAlign&&(u=m.x2-2-P.width-D),N=this.horizontalAlign,
this.width=P.width,this.height=P.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(u=m.x1+2,x=m.y2-2-(this.maxWidth/2-P.width/2),E=-90,J="left",this.width=P.height,this.height=P.width):"right"===this.horizontalAlign?(u=m.x2-2,x=m.y1+2+(this.maxWidth/2-P.width/2),E=90,J="right",this.width=P.height,this.height=P.width):"center"===this.horizontalAlign&&(x=h.y1+(h.height/2-P.height/2),u=h.x1+(h.width/2-P.width/2),J="center",this.width=P.width,this.height=P.height),N="center");I.x=
u;I.y=x;I.angle=E;I.horizontalAlign=N;this._textBlock=I;h.layoutManager.registerSpace(J,{width:this.width+("left"===J||"right"===J?this.margin+2:0),height:this.height+("top"===J||"bottom"===J?this.margin+2:0)});this.bounds={x1:u,y1:x,x2:u+this.width,y2:x+this.height};this.ctx.textBaseline="top"}};xa.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};na(Ha,I);Ha.prototype.setLayout=xa.prototype.setLayout;Ha.prototype.render=xa.prototype.render;Ua.prototype.get=function(h,m){var s=
null;0<this.pool.length?(s=this.pool.pop(),La(s,h,m)):s=ra(h,m);return s};Ua.prototype.release=function(h){this.pool.push(h)};na(Ia,I);var Oa={addTheme:function(h,m){bb[h]=m},addColorSet:function(h,m){ya[h]=m},addCultureInfo:function(h,m){Ja[h]=m},formatNumber:function(h,m,s){s=s||"en";if(Ja[s])return da(h,m||"#,##0.##",new Ia(s));throw"Unknown Culture Name";},formatDate:function(h,m,s){s=s||"en";if(Ja[s])return za(h,m||"DD MMM YYYY",new Ia(s));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
...
2+1;var B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[v].x>a[f].x&&0<B||a[v].x<a[f].x&&0>B?{x:a[v].x+B/3,y:a[v].y+b/3}:{x:a[v].x,y:a[v].y+b/9};v=e;f=0===v?0:v-1;l=v===a.length-1?v:v+1;b=Math.abs((a[l].x-a[f].x)/(0===a[v].x-a[f].x?0.01:a[v].x-a[f].x))*(d-1)/2+1;B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[v].x>a[f].x&&0<B||a[v].x<a[f].x&&0>B?{x:a[v].x-B/3,y:a[v].y-b/3}:{x:a[v].x,y:a[v].y-b/9};c[c.length]=a[e]}return c}function x(a,d,c,b,e,f,l,v,B,k){var n=0;k?(l.color=f,v.color=f):
...
new Ia(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&u;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Ta(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)fa(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+
...
J(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},a.toolTip);a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=!1);if(a.sessionVariables.axisX)for(var b=0;b<a.sessionVariables.axisX.length;b++)a.sessionVariables.axisX[b].newViewportMinimum=null,a.sessionVariables.axisX[b].newViewportMaximum=
...
this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new K(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=
...
(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||ta(this._zoomButton,this._resetButton);this.toolTip._updateToolTip();this.renderCount++;Ga&&(n=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(La(a,n.width,n.height),a.getContext("2d").drawImage(n._eventManager.ghostCanvas,0,0))},2E3));this._breaksCanvas&&(delete this._breaksCanvas,delete this._breaksCanvasCtx);for(k=0;k<this._axes.length;k++)this._axes[k].maskCanvas&&(delete this._axes[k].maskCanvas,
...
"waterfall"===b.type&&this._processSpecificPlotUnit(b)}this.calculateAutoBreaks()};m.prototype._processMultiseriesPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var v=this.data[a.dataSeriesIndexes[l]],B=0,k=!1,n=!1,p;if("normal"===v.axisPlacement||"xySwapped"===v.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&
this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(v.dataPoints[B].x&&v.dataPoints[B].x.getTime||"dateTime"===
v.xValueType)f=!0;for(B=0;B<v.dataPoints.length;B++){"undefined"===typeof v.dataPoints[B].x&&(v.dataPoints[B].x=B+(a.axisX.logarithmic?1:0));v.dataPoints[B].x.getTime?(f=!0,b=v.dataPoints[B].x.getTime()):b=v.dataPoints[B].x;e=v.dataPoints[B].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);e>d.max&&"number"===typeof e&&(d.max=e);if(0<B){if(a.axisX.logarithmic){var r=b/v.dataPoints[B-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-v.dataPoints[B-1].x,0>r&&
(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==v.dataPoints[B-1].y&&(a.axisY.logarithmic?(r=e/v.dataPoints[B-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-v.dataPoints[B-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;v.dataPoints[B].label&&(a.axisX.labels[b]=v.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===
...
m)}else m=b-p.dataPoints[q-1].x,0>m&&(m*=-1),c.minDiff>m&&0!==m&&(c.minDiff=m);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(m=e/p.dataPoints[q-1].y,1>m&&(m=1/m),d.minDiff>m&&1!==m&&(d.minDiff=m)):(m=e-p.dataPoints[q-1].y,0>m&&(m*=-1),d.minDiff>m&&0!==m&&(d.minDiff=m)))}if(b<Pa&&!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>t&&!r)r=!0;else if(b>t&&r)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=
b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,B=Math.min(e,B)):v[b]?v[b]+=e:(v[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,
v)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=v));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,B)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,B)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in v)v.hasOwnProperty(q)&&!isNaN(q)&&(a=v[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=
...
0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(v=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!v?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&
...
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(k.dataPoints[n].x&&k.dataPoints[n].x.getTime||"dateTime"===k.xValueType)v=!0;for(n=0;n<k.dataPoints.length;n++){"undefined"===typeof k.dataPoints[n].x&&(k.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));k.dataPoints[n].x.getTime?(v=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var y=
0;y<e.length;y++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/k.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[n-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[n-1].y[0],
0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>t&&!q)q=!0;else if(b>t&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(y=0;y<e.length;y++)if(null===e[y]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}k.axisX.valueType=
...
this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(v.dataPoints[B].x&&v.dataPoints[B].x.getTime||"dateTime"===v.xValueType)f=!0;for(B=0;B<v.dataPoints.length;B++)"undefined"!==
typeof v.dataPoints[B].isCumulativeSum&&!0===v.dataPoints[B].isCumulativeSum?(v.dataPointEOs[B].cumulativeSumYStartValue=0,v.dataPointEOs[B].cumulativeSum=0===B?0:v.dataPointEOs[B-1].cumulativeSum,v.dataPoints[B].y=0===B?0:v.dataPointEOs[B-1].cumulativeSum):"undefined"!==typeof v.dataPoints[B].isIntermediateSum&&!0===v.dataPoints[B].isIntermediateSum?(v.dataPointEOs[B].cumulativeSumYStartValue=p,v.dataPointEOs[B].cumulativeSum=0===B?0:v.dataPointEOs[B-1].cumulativeSum,v.dataPoints[B].y=0===B?0:b,
p=0===B?0:v.dataPointEOs[B-1].cumulativeSum,b=0):(e="number"!==typeof v.dataPoints[B].y?0:v.dataPoints[B].y,v.dataPointEOs[B].cumulativeSumYStartValue=0===B?0:v.dataPointEOs[B-1].cumulativeSum,v.dataPointEOs[B].cumulativeSum=0===B?e:v.dataPointEOs[B-1].cumulativeSum+e,b+=e);for(B=0;B<v.dataPoints.length;B++)if("undefined"===typeof v.dataPoints[B].x&&(v.dataPoints[B].x=B+(a.axisX.logarithmic?1:0)),v.dataPoints[B].x.getTime?(f=!0,b=v.dataPoints[B].x.getTime()):b=v.dataPoints[B].x,e=v.dataPoints[B].y,
b<c.min&&(c.min=b),b>c.max&&(c.max=b),v.dataPointEOs[B].cumulativeSum<d.min&&(d.min=v.dataPointEOs[B].cumulativeSum),v.dataPointEOs[B].cumulativeSum>d.max&&(d.max=v.dataPointEOs[B].cumulativeSum),0<B&&(a.axisX.logarithmic?(p=b/v.dataPoints[B-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-v.dataPoints[B-1].x,0>p&&(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==v.dataPoints[B-1].y&&(a.axisY.logarithmic?(e=v.dataPointEOs[B].cumulativeSum/v.dataPointEOs[B-1].cumulativeSum,1>e&&
(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=v.dataPointEOs[B].cumulativeSum-v.dataPointEOs[B-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;v.dataPoints[B].label&&(a.axisX.labels[b]=v.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<B&&(v.dataPointEOs[B-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=v.dataPointEOs[B-1].cumulativeSum),v.dataPointEOs[B-
1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=v.dataPointEOs[B-1].cumulativeSum));v.dataPointEOs[B].cumulativeSum<d.viewPortMin&&(d.viewPortMin=v.dataPointEOs[B].cumulativeSum);v.dataPointEOs[B].cumulativeSum>d.viewPortMax&&(d.viewPortMax=v.dataPointEOs[B].cumulativeSum)}v.axisX.valueType=v.xValueType=f?"dateTime":"number"}};m.prototype.calculateAutoBreaks=function(){function a(a,b,c,e){if(e)return c=Math.pow(Math.min(c*a/b,b/a),0.2),1>=c&&(c=Math.pow(1>a?1/a:Math.min(b/a,a),0.25)),{startValue:a*
...
d=d._dataRanges,q,v=0,B=0;B<a.dataSeriesIndexes.length;B++){var h=e.data[a.dataSeriesIndexes[B]];if(!(4>h.dataPoints.length))for(v=0;v<h.dataPoints.length;v++)if(b&&(q=(l+1-k)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,g=h.dataPoints[v].x.getTime?h.dataPoints[v].x.getTime():h.dataPoints[v].x,q=Math.floor((g-k)/q),g<f[q].min&&(f[q].min=g),g>f[q].max&&(f[q].max=g)),c){var m=(p+1-n)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||10,10)/100;if((g="waterfall"===
...
n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(v in q)if(q.hasOwnProperty(v)&&!isNaN(v)&&(p=q[v],!s(p))){var g=Math.floor((p-B)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(v in q)q.hasOwnProperty(v)&&!isNaN(v)&&(p=-1*q[v],s(p)||(g=Math.floor((p-B)/b),p<n[g].min&&
(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(v=0;v<k.length-1;v++)if(n=k[v].max,isFinite(n))for(;v<k.length-1;)if(B=k[v+1].min,isFinite(B)){p=B-n;p>b&&f.push({diff:p,start:n,end:B});break}else v++;if(this._axes[l].scaleBreaks.customBreaks)for(v=0;v<this._axes[l].scaleBreaks.customBreaks.length;v++)for(b=0;b<f.length;b++)if(this._axes[l].scaleBreaks.customBreaks[v].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[v].endValue||
...
(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};m.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(u)b=Za(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=lb;m.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};
...
l=0<=this.zoomType.indexOf("y"),v=!1,B=[],k=[],n=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&f||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var r=g,g=q,q=r;if(p.scaleBreaks)for(r=0;!f&&r<p.scaleBreaks._appliedBreaks.length;r++)f=p.scaleBreaks._appliedBreaks[r].startValue<=q&&p.scaleBreaks._appliedBreaks[r].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(r=
p.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&r<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))B.push(p),n.push({val1:q,val2:g}),v=!0;else if(!e){v=!1;break}}return{isValid:v,axesWithValidRange:B,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!u&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&
...
new Ca(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,v=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ka("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ka("indexLabelFontSize",n.dataPoint,n.dataSeries),v=ka("indexLabelFontFamily",n.dataPoint,n.dataSeries),B=ka("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ka("indexLabelFontWeight",n.dataPoint,
n.dataSeries),h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ka("indexLabelMaxWidth",n.dataPoint,n.dataSeries);g=ka("indexLabelWrap",n.dataPoint,n.dataSeries);var m=ka("indexLabelLineDashType",n.dataPoint,n.dataSeries),t=ka("indexLabelLineColor",n.dataPoint,n.dataSeries),y=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?
this.plotArea.height:this.plotArea.width)<<0):0,z={percent:null,total:null},F=null;if(0<=n.dataSeries.type.indexOf("stacked")||"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)z=this.getPercentAndTotal(n.dataSeries,n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)F={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:z.total,percent:z.percent};var C=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(F):n.dataPoint.indexLabel?
this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(F):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==C&&""!==C){var z=ka("indexLabelPlacement",n.dataPoint,n.dataSeries),F=ka("indexLabelOrientation",n.dataPoint,n.dataSeries),A=ka("indexLabelTextAlign",n.dataPoint,n.dataSeries),w=n.direction,e=n.dataSeries.axisX,
f=n.dataSeries.axisY,x=!1,h=new ha(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===F?0:-90,text:C,padding:0,backgroundColor:h,textAlign:A,fontSize:r,fontFamily:v,fontWeight:k,fontColor:l,fontStyle:B,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||
...
e.viewportMaximum)continue;l=v=2;"horizontal"===F?(B=h.width,k=h.height):(k=h.width,B=h.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))z="auto",v=4;else if(0<=p.indexOf("stacked"))"auto"===z&&(z="inside");else if("bubble"===p||"scatter"===p)z="inside";q=n.point.x-("horizontal"===F?B/2:B/2-r/2);"inside"!==z?(e=c.y1,f=c.y2,0<w?(g=n.point.y+("horizontal"===F?r/2:0)-k-v-b,g<e&&(g="auto"===z?Math.max(n.point.y,e)+r/2+v:e+r/2+v,x=g+k>n.point.y)):(g=n.point.y+
r/2+v+b,g>f-k&&(g="auto"===z?Math.min(n.point.y,f)+r/2-k-v:f+r/2-k,x=g<n.point.y))):(e=Math.max(n.bounds.y1,c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<w?Math.max(n.bounds.y1,c.y1)+r/2+v:Math.min(n.bounds.y2,c.y2)+r/2-k+v:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===F?v:0),0<w?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-v,c.y1+v))):(g=Math.min(n.point.y,b),g>f-k-v&&("bubble"===p||"scatter"===
p)&&(g=Math.min(n.point.y+v,c.y2-k-v))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(z="auto",l=4):0<=p.indexOf("stacked")?"auto"===z&&(z="inside"):"bubble"===p&&(z="inside"),g=n.point.y+r/2-k/2+v,"inside"!==z?(e=c.x1,f=c.x2,0>w?(q=n.point.x-("horizontal"===F?B:B-r/2)-l-b,q<e&&(q="auto"===z?Math.max(n.point.x,e)+l:e+l,x=q+B>n.point.x)):(q=n.point.x+("horizontal"===F?0:r/2)+l+b,q>f-B-l-b&&(q="auto"===z?Math.min(n.point.x,f)-("horizontal"===F?B:B/2)-l:f-
B-l,x=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>w?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-B/2-l+("horizontal"===F?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===F?0:r/2),q=0>w?Math.max(n.point.x,b)-("horizontal"===F?B/2:0):Math.min(n.point.x,b)-B/2,q=Math.max(q,e));"vertical"===F&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);y&&("inside"!==z&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&
n.point.x>c.x1&&n.point.x<c.x2||!x)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&n.point.y<c.y2||!x))&&(d.lineWidth=y,d.strokeStyle=t?t:"gray",d.setLineDash&&d.setLineDash(N(m,y)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:B+l)+("vertical"===F?-r/2:0),g+("vertical"===F?-k/2:k/2-r/2)-v):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+B/2-("horizontal"===F?0:r/2),g+("vertical"===F?
(g-k<n.point.y?0:-k)+v:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+B/2-("horizontal"===F?0:r/2),g+("vertical"===F?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=s(h)?u?"transparent":null:h;
...
g=N(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,y,s;c.beginPath();if(0<n.length){for(var F=!1,t=0;t<n.length;t++)if(y=n[t].x.getTime?n[t].x.getTime():n[t].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!F)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||F||m)&&(c.stroke(),u&&b.stroke()),F=!0;else{y=a.axisX.convertValueToPixel(y);s=a.axisY.convertValueToPixel(n[t].y);var C=k.dataPointIds[t];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:t,x1:y,y1:s};m||F?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,
c.setLineDash(q)),c.lineTo(y,s),u&&b.lineTo(y,s)):(c.beginPath(),c.moveTo(y,s),u&&(b.beginPath(),b.moveTo(y,s))),F=m=!1):(c.lineTo(y,s),u&&b.lineTo(y,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(y,s),u&&(b.stroke(),b.beginPath(),b.moveTo(y,s))));l={x:y,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(y,s),h=n[t].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(N(p,k.lineThickness))):
(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize){var A=k.getMarkerProperties(t,y,s,c);f.push(A);C=R(C);u&&f.push({x:y,y:s,ctx:b,type:A.type,size:A.size,color:C,borderColor:C,borderThickness:A.borderThickness})}(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:k,point:{x:y,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();u&&b.stroke()}}W.drawMarkers(f);u&&
...
easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,v=0;v<a.dataSeriesIndexes.length;v++){var B=a.dataSeriesIndexes[v],k=this.data[B];c.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(c.setLineDash){var q=N(k.nullDataLineDashType,
k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,y,s;c.beginPath();if(0<n.length){for(var F=!1,t=0;t<n.length;t++)if(y=n[t].getTime?n[t].x.getTime():n[t].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&
(!k.connectNullData||!F)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||F||m)&&(c.stroke(),u&&b.stroke()),F=!0;else{var C=s;y=a.axisX.convertValueToPixel(y);s=a.axisY.convertValueToPixel(n[t].y);var A=k.dataPointIds[t];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:t,x1:y,y1:s};m||F?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,
l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(y,C),c.lineTo(y,s),u&&(b.lineTo(y,C),b.lineTo(y,s))):(c.beginPath(),c.moveTo(y,s),u&&(b.beginPath(),b.moveTo(y,s))),F=m=!1):(c.lineTo(y,C),u&&b.lineTo(y,C),c.lineTo(y,s),u&&b.lineTo(y,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(y,s),u&&(b.stroke(),b.beginPath(),b.moveTo(y,s))));l={x:y,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(y,s),h=n[t].lineColor||r,c.strokeStyle=
h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize)C=k.getMarkerProperties(t,y,s,c),f.push(C),A=R(A),u&&f.push({x:y,y:s,ctx:b,type:C.type,size:C.size,color:A,borderColor:A,borderThickness:C.borderThickness});(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:k,point:{x:y,y:s},direction:0>
...
c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderSpline=function(a){function d(a){a=w(a,2);if(0<a.length){b.beginPath();u&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);u&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],v=0;v<a.dataSeriesIndexes.length;v++){var B=a.dataSeriesIndexes[v],k=this.data[B];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);e.strokeStyle=r;e.lineWidth=
0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,t,s,z=[];b.beginPath();if(0<n.length)for(s=!1,m=0;m<n.length;m++)if(t=n[m].getTime?n[m].x.getTime():n[m].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!s)))if("number"!==typeof n[m].y)0<m&&!s&&(k.connectNullData?b.setLineDash&&(0<z.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(z[z.length-
1].newLineDashArray=q,p=k.nullDataLineDashType):(d(z),z=[])),s=!0;else{t=a.axisX.convertValueToPixel(t);s=a.axisY.convertValueToPixel(n[m].y);var F=k.dataPointIds[m];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:m,x1:t,y1:s};z[z.length]={x:t,y:s};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,z[z.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,z[z.length-1].newLineDashArray=
N(p,k.lineThickness)):(p=k.lineDashType,z[z.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var C=k.getMarkerProperties(m,t,s,b);l.push(C);F=R(F);u&&l.push({x:t,y:s,ctx:e,type:C.type,size:C.size,color:F,borderColor:F,borderThickness:C.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:t,y:s},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});s=!1}d(z)}W.drawMarkers(l);
...
0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(B);v=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,t;0<=r[f].y?t=k:(t=v,v=k);v>t&&(b=v,v=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];
ba(c,l,v,m,t,b,0,null,h&&0<=r[f].y,0>r[f].y&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:v,x2:m,y2:t};b=R(b);u&&ba(this._eventManager.ghostCtx,l,v,m,t,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?v:t},direction:0>r[f].y===
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};m.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],v=[],B=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=
...
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);var z=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,F=z+g<<0,C;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)v[b]=t[k].y+(v[b]?v[b]:
0),0<v[b]&&(p=a.axisY.convertValueToPixel(v[b]),C="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=t[k].y+(B[b]?B[b]:0),C=a.axisY.convertValueToPixel(B[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=C;else if(p=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var A="undefined"!==typeof f[b]?f[b]:0;p-=A;C=q-A;f[b]=A+(C-p)}else A=l[b]?l[b]:0,C=p+A,p=q+A,l[b]=A+(C-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];
ba(c,z,p,F,C,b,0,null,s&&0<=t[k].y,0>t[k].y&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:F,y2:C};b=R(b);u&&ba(this._eventManager.ghostCtx,z,p,F,C,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:C},direction:0>t[k].y===a.axisY.reversed?
1:-1,bounds:{x1:z,y1:Math.min(p,C),x2:F,y2:Math.max(p,C)},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],v=[],B=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
k>n&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<k)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>n&&(g=n);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length)for(var s=5<g&&m.bevelEnabled?!0:!1,k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var z=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,F=z+g<<0,C;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<t[k].y){v[b]=p+("undefined"!==typeof v[b]?v[b]:0);if(0>=v[b])continue;p=a.axisY.convertValueToPixel(v[b]);C=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=p+("undefined"!==typeof B[b]?B[b]:0),C=a.axisY.convertValueToPixel(B[b]),p=l[b]?l[b]:q,l[b]=C;else if(p=a.axisY.convertValueToPixel(p),0<=t[k].y){var A="undefined"!==typeof f[b]?f[b]:0;p-=A;C=q-A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=A+(C-p)}else A="undefined"!==
typeof l[b]?l[b]:0,C=p+A,p=q+A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-C)&&(C=e.y2),l[b]=A+(C-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ba(c,z,p,F,C,b,0,null,s&&0<=t[k].y,0>t[k].y&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:F,y2:C};b=R(b);u&&ba(this._eventManager.ghostCtx,z,p,F,C,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:C},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:z,y1:Math.min(p,C),x2:F,y2:Math.max(p,C)},color:b})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,f=0,l,v,B,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.options.dataPointWidth?
...
c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){v=a.axisX.convertValueToPixel(B);
l=a.axisY.convertValueToPixel(r[f].y);v=a.axisX.reversed?v+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:v-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?v-p<<0:v+p<<0,t;0<=r[f].y?t=k:(t=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ba(c,t,v,l,m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:t,y1:v,x2:l,y2:m};b=
R(b);u&&ba(this._eventManager.ghostCtx,t,v,l,m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:t,y:v+(m-v)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(t,l),y1:v,x2:Math.max(t,l),y2:m},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var z=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,F=z+g<<0,C;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)v[b]=t[k].y+(v[b]?v[b]:0),0<v[b]&&(C=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(v[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=t[k].y+(B[b]?B[b]:0),n=l[b]?
l[b]:q,l[b]=C=a.axisY.convertValueToPixel(B[b]);else if(n=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var A=f[b]?f[b]:0;C=q+A;n+=A;f[b]=A+(n-C)}else A=l[b]?l[b]:0,C=n-A,n=q-A,l[b]=A+(n-C);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ba(c,C,z,n,F,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:C,y1:z,x2:n,y2:F};b=R(b);u&&ba(this._eventManager.ghostCtx,C,z,n,F,b,0,null,!1,!1,!1,
!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:C,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(C,n),y1:z,x2:Math.max(C,n),y2:F},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderStackedBar100=function(a){var d=
...
"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var z;z=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var F=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=F+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){v[b]=z+(v[b]?v[b]:0);if(0>=v[b])continue;z=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(v[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=z+(B[b]?B[b]:0),n=l[b]?l[b]:
q,l[b]=z=a.axisY.convertValueToPixel(B[b]);else if(n=a.axisY.convertValueToPixel(z),0<=t[k].y){var A=f[b]?f[b]:0;z=q+A;n+=A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=A+(n-z)}else A=l[b]?l[b]:0,z=n-A,n=q-A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-z)&&(z=e.x1),l[b]=A+(n-z);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ba(c,z,F,n,C,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,
dataPointIndex:k,x1:z,y1:F,x2:n,y2:C};b=R(b);u&&ba(this._eventManager.ghostCtx,z,F,n,C,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:z,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,n),y1:F,x2:Math.max(z,n),y2:C},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){C&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?F=z:0>a.axisY.viewportMaximum?F=v.y1:0<a.axisY.viewportMinimum&&(F=z),f.lineTo(m,F),f.lineTo(C.x,F),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(l.lineTo(m,F),l.lineTo(C.x,F),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),C={x:m,y:t})}
...
B=R(B);l.fillStyle=B;B=[];d=!0;var h=0,m,t,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),F,C=null;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||A,x=w;f.fillStyle=A;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var S=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var O=N(c,g.lineThickness);f.setLineDash(O)}for(var ia=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||
s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ia)))if("number"!==typeof r[h].y)g.connectNullData||(ia||d)||b(),ia=!0;else{m=a.axisX.convertValueToPixel(s);t=a.axisY.convertValueToPixel(r[h].y);d||ia?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,C=n,c=g.nullDataLineDashType,f.setLineDash(S)),f.lineTo(m,t),u&&l.lineTo(m,t)):(f.beginPath(),f.moveTo(m,t),u&&
(l.beginPath(),l.moveTo(m,t)),C={x:m,y:t}),ia=d=!1):(f.lineTo(m,t),u&&l.lineTo(m,t),0==h%250&&b());n={x:m,y:t};h<r.length-1&&(x!==(r[h].lineColor||w)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||w,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(O))));var $=g.dataPointIds[h];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t};0!==r[h].markerSize&&
(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,t,f),B.push(s),$=R($),u&&B.push({x:m,y:t,ctx:l,type:s.type,size:s.size,color:$,borderColor:$,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A})}b();W.drawMarkers(B)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
m=f.y1:0<a.axisY.viewportMinimum&&(m=h);t={x:c[0].x,y:c[0].y};b.lineTo(c[c.length-1].x,m);b.lineTo(t.x,m);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;u&&(e.lineTo(c[c.length-1].x,m),e.lineTo(t.x,m),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],v=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(v.x1,v.y1,v.width,v.height);
b.clip();u&&(e.beginPath(),e.rect(v.x1,v.y1,v.width,v.height),e.clip());for(var B=0;B<a.dataSeriesIndexes.length;B++){var k=a.dataSeriesIndexes[B],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=R(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,t=null,s=[];if(0<p.length){var z=n._colorSet[q%n._colorSet.length],F=n.lineColor=n.options.lineColor||z,C=F;b.fillStyle=z;b.strokeStyle=
F;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=N(n.nullDataLineDashType,n.lineThickness),A=n.lineDashType,D=N(A,n.lineThickness);b.setLineDash(D)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<s.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=x,
A=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var S=n.dataPointIds[q];this._eventManager.objectMap[S]={id:S,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(C!==(p[q].lineColor||F)||A!==(p[q].lineDashType||n.lineDashType))&&(C=p[q].lineColor||F,s[s.length-1].newStrokeStyle=C,b.setLineDash&&(p[q].lineDashType?(A=p[q].lineDashType,s[s.length-1].newLineDashArray=N(A,n.lineThickness)):
(A=n.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var O=n.getMarkerProperties(q,g,r,b);l.push(O);S=R(S);u&&l.push({x:g,y:r,ctx:e,type:O.type,size:O.size,color:S,borderColor:S,borderThickness:O.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:z});
r=!1}d();W.drawMarkers(l)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(v.x1,v.y1,v.width,v.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,
dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){C&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?F=z:0>a.axisY.viewportMaximum?F=v.y1:0<a.axisY.viewportMinimum&&(F=z),f.lineTo(m,F),f.lineTo(C.x,F),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(l.lineTo(m,F),l.lineTo(C.x,F),l.closePath(),l.fill()),
f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),C={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=u?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,v=a.axisY.lineCoordinates,B=[],k=this.plotArea,n;f.save();u&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();u&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,
B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=R(B);l.fillStyle=B;B=[];d=!0;var h=0,m,t,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),F,C=null;c=!1;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||A,x=w;f.fillStyle=A;f.strokeStyle=w;f.lineWidth=g.lineThickness;var S="solid";if(f.setLineDash){var O=N(g.nullDataLineDashType,g.lineThickness),S=g.lineDashType,D=N(S,g.lineThickness);f.setLineDash(D)}for(;h<
r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=t;"number"!==typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(s),t=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||S===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,C=n,S=g.nullDataLineDashType,
f.setLineDash(O)),f.lineTo(m,$),f.lineTo(m,t),u&&(l.lineTo(m,$),l.lineTo(m,t))):(f.beginPath(),f.moveTo(m,t),u&&(l.beginPath(),l.moveTo(m,t)),C={x:m,y:t}),c=d=!1):(f.lineTo(m,$),u&&l.lineTo(m,$),f.lineTo(m,t),u&&l.lineTo(m,t),0==h%250&&b()),n={x:m,y:t},h<r.length-1&&(x!==(r[h].lineColor||w)||S!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||w,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(S=r[h].lineDashType,f.setLineDash(N(S,g.lineThickness))):(S=g.lineDashType,f.setLineDash(D)))),
s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t},0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&($=g.getMarkerProperties(h,m,t,f),B.push($),s=R(s),u&&B.push({x:m,y:t,ctx:l,type:$.type,size:$.size,color:s,borderColor:s,borderThickness:$.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:r[h],dataSeries:g,point:{x:m,
y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A}))}b();W.drawMarkers(B)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());
f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);u&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:
c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],v=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,t,y,z;u&&s.beginPath();b.save();u&&s.save();b.beginPath();b.rect(v.x1,v.y1,v.width,v.height);b.clip();u&&(s.beginPath(),s.rect(v.x1,v.y1,v.width,v.height),s.clip());for(var e=[],F=0;F<a.dataSeriesIndexes.length;F++){var C=a.dataSeriesIndexes[F],A=this.data[C],w=A.dataPoints;A.dataPointIndexes=
[];for(q=0;q<w.length;q++)C=w[q].x.getTime?w[q].x.getTime():w[q].x,A.dataPointIndexes[C]=q,e[C]||(n.push(C),e[C]=!0);n.sort(Qa)}for(F=0;F<a.dataSeriesIndexes.length;F++){C=a.dataSeriesIndexes[F];A=this.data[C];w=A.dataPoints;y=!0;k=[];q=A.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:C};q=R(q);s.fillStyle=q;if(0<n.length){var e=A._colorSet[0],x=A.lineColor=A.options.lineColor||e,S=x;b.fillStyle=e;b.strokeStyle=x;b.lineWidth=A.lineThickness;z="solid";if(b.setLineDash){var O=
N(A.nullDataLineDashType,A.lineThickness);z=A.lineDashType;var D=N(z,A.lineThickness);b.setLineDash(D)}for(var $=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=A.dataPointIndexes[f]?w[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||($||y)||d(),$=!0;else{g=a.axisX.convertValueToPixel(f);var la=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=
ea.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ea.y),r-=la;k.push({x:g,y:m-la});h[f]=m-r;y||$?(!y&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||z===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(y=k.pop(),z=k[k.length-1],d(),b.moveTo(t.x,t.y),k.push(z),k.push(y),z=A.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,r),u&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),u&&(s.beginPath(),
s.moveTo(g,r))),$=y=!1):(b.lineTo(g,r),u&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),u&&s.moveTo(g,r),k.push({x:g,y:m-la})));t={x:g,y:r};q<w.length-1&&(S!==(w[q].lineColor||x)||z!==(w[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-la}),S=w[q].lineColor||x,b.strokeStyle=S,b.setLineDash&&(w[q].lineDashType?(z=w[q].lineDashType,b.setLineDash(N(z,A.lineThickness))):(z=A.lineDashType,b.setLineDash(D))));if(0<=A.dataPointIndexes[f]){var E=A.dataPointIds[A.dataPointIndexes[f]];
this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(la=A.getMarkerProperties(A.dataPointIndexes[f],g,r,b),l.push(la),f=R(E),u&&l.push({x:g,y:r,ctx:s,type:la.type,size:la.size,color:f,borderColor:f,borderThickness:la.borderThickness}));(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",
dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);u&&s.moveTo(g,r)}delete A.dataPointIndexes}W.drawMarkers(l);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(v.x1,v.y1,v.width,v.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);u&&z.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(z.closePath(),z.fill(),z.beginPath());k=[]}
var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,v=[],h=[],k=[],n=[],p=[],q=0,g,r,m,s,t,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z=this._eventManager.ghostCtx;b.save();u&&z.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(z.beginPath(),z.rect(l.x1,l.y1,l.width,l.height),z.clip());for(var e=[],F=0;F<a.dataSeriesIndexes.length;F++){var w=a.dataSeriesIndexes[F],
A=this.data[w],x=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<x.length;q++)w=x[q].x.getTime?x[q].x.getTime():x[q].x,A.dataPointIndexes[w]=q,e[w]||(n.push(w),e[w]=!0);n.sort(Qa)}for(F=0;F<a.dataSeriesIndexes.length;F++){w=a.dataSeriesIndexes[F];A=this.data[w];x=A.dataPoints;s=!0;e=A.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:w};e=R(e);z.fillStyle=e;k=[];if(0<n.length){var e=A._colorSet[q%A._colorSet.length],D=A.lineColor=A.options.lineColor||e,S=D;b.fillStyle=e;b.strokeStyle=
D;b.lineWidth=A.lineThickness;t="solid";if(b.setLineDash){var O=N(A.nullDataLineDashType,A.lineThickness);t=A.lineDashType;var E=N(t,A.lineThickness);b.setLineDash(E)}for(var $=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=A.dataPointIndexes[f]?x[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||($||s)||d(),$=!0;else{var la;la=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):
0;g=a.axisX.convertValueToPixel(f);var aa=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=la+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(la),r-=aa;k.push({x:g,y:y-aa});h[f]=y-r;s||$?(!s&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||t===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(s=k.pop(),t=k[k.length-1],d(),b.moveTo(m.x,
m.y),k.push(t),k.push(s),t=A.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,r),u&&z.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),u&&(z.beginPath(),z.moveTo(g,r))),$=s=!1):(b.lineTo(g,r),u&&z.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),u&&z.moveTo(g,r),k.push({x:g,y:y-aa})));m={x:g,y:r};q<x.length-1&&(S!==(x[q].lineColor||D)||t!==(x[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:y-aa}),S=x[q].lineColor||D,b.strokeStyle=S,b.setLineDash&&(x[q].lineDashType?(t=x[q].lineDashType,
b.setLineDash(N(t,A.lineThickness))):(t=A.lineDashType,b.setLineDash(E))));if(0<=A.dataPointIndexes[f]){var G=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(aa=A.getMarkerProperties(q,g,r,b),v.push(aa),f=R(G),u&&v.push({x:g,y:r,ctx:z,type:aa.type,size:aa.size,color:f,borderColor:f,borderThickness:aa.borderThickness}));
(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>x[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);u&&z.moveTo(g,r)}delete A.dataPointIndexes}W.drawMarkers(v);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
var g=q[e].z,s=2*Math.max(Math.sqrt((v===h?m/2:r+(m-r)/(v-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=p.fillOpacity;W.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var t=p.dataPointIds[e];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:f,y1:l,size:s};s=R(t);u&&W.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||
q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null})}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();u&&this._eventManager.ghostCtx.save();
c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var h=a.dataSeriesIndexes[v],k=this.data[h],n=k.dataPoints;if(0<n.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var p=0,q=0,e=0;e<n.length;e++)if(f=n[e].getTime?f=n[e].x.getTime():f=n[e].x,!(f<a.axisX.dataInfo.viewPortMin||
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof n[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(n[e].y);var g=k.getMarkerProperties(e,f,l,c);c.globalAlpha=k.fillOpacity;W.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,
dataPointIndex:e,x1:f,y1:l},p=R(p),u&&W.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||k.indexLabel||n[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),p=f,q=l)}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderCandlestick=
...
l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var Pa=a.dataSeriesIndexes[m],t=this.data[Pa],y=t.dataPoints;if(0<y.length)for(var z=5<r&&t.bevelEnabled?!0:!1,v=0;v<y.length;v++)if(y[v].getTime?g=y[v].x.getTime():g=y[v].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(y[v].y)&&y[v].y.length&&"number"===typeof y[v].y[0]&&"number"===typeof y[v].y[1]&&"number"===typeof y[v].y[2]&&"number"===typeof y[v].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[v].y[0]);
n=a.axisY.convertValueToPixel(y[v].y[1]);p=a.axisY.convertValueToPixel(y[v].y[2]);q=a.axisY.convertValueToPixel(y[v].y[3]);var F=h-r/2<<0,w=F+r<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=y[v].color?y[v].color:t._colorSet[0],A=Math.round(Math.max(1,0.15*r)),x=0===A%2?0:0.5,D=t.dataPointIds[v];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:Pa,dataPointIndex:v,x1:F,y1:k,x2:w,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:A,color:e};c.strokeStyle=e;c.beginPath();
c.lineWidth=A;b.lineWidth=Math.max(A,4);"candlestick"===t.type?(c.moveTo(h-x,n),c.lineTo(h-x,Math.min(k,q)),c.stroke(),c.moveTo(h-x,Math.max(k,q)),c.lineTo(h-x,p),c.stroke(),ba(c,F,Math.min(k,q),w,Math.max(k,q),y[v].y[0]<=y[v].y[3]?t.risingColor:f,A,e,z,z,!1,!1,t.fillOpacity),u&&(e=R(D),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,Math.min(k,q)),b.stroke(),b.moveTo(h-x,Math.max(k,q)),b.lineTo(h-x,p),b.stroke(),ba(b,F,Math.min(k,q),w,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(h-
x,n),c.lineTo(h-x,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(F,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(w,q),c.stroke(),u&&(e=R(D),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(F,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(w,q),b.stroke()));(y[v].indexLabel||t.indexLabel||y[v].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:y[v],dataSeries:t,point:{x:F+(w-F)/2,y:a.axisY.reversed?
p:n},direction:1,bounds:{x1:F,y1:Math.min(n,p),x2:w,y2:Math.max(n,p)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),b.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,l=0,v,h,k,n,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?
...
this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>l&&(r=l);c.save();u&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();u&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,w=0;w<a.dataSeriesIndexes.length;w++){var t=a.dataSeriesIndexes[w],y=this.data[t],z=y.dataPoints;if(0<z.length)for(var F=5<r&&y.bevelEnabled?!0:!1,l=0;l<z.length;l++)if(z[l].getTime?g=z[l].x.getTime():g=z[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&
!s(z[l].y)&&z[l].y.length&&"number"===typeof z[l].y[0]&&"number"===typeof z[l].y[1]&&"number"===typeof z[l].y[2]&&"number"===typeof z[l].y[3]&&"number"===typeof z[l].y[4]&&5===z[l].y.length){v=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(z[l].y[0]);k=a.axisY.convertValueToPixel(z[l].y[1]);n=a.axisY.convertValueToPixel(z[l].y[2]);p=a.axisY.convertValueToPixel(z[l].y[3]);q=a.axisY.convertValueToPixel(z[l].y[4]);var C=v-r/2<<0,A=v+r/2<<0,e=z[l].color?z[l].color:y._colorSet[0],x=Math.round(Math.max(1,
0.15*r)),D=0===x%2?0:0.5,S=z[l].whiskerColor?z[l].whiskerColor:z[l].color?y.whiskerColor?y.whiskerColor:z[l].color:y.whiskerColor?y.whiskerColor:e,O="number"===typeof z[l].whiskerThickness?z[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:x,E=z[l].whiskerDashType?z[l].whiskerDashType:y.whiskerDashType,$=s(z[l].whiskerLength)?s(y.options.whiskerLength)?r:y.whiskerLength:z[l].whiskerLength,$="number"===typeof $?0>=$?0:$>=r?r:$:"string"===typeof $?parseInt($)*r/100>
...
z[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:x,P=z[l].lineDashType?z[l].lineDashType:y.lineDashType,L=1===Math.round(K)%2?0.5:0,T=y.upperBoxColor,va=y.lowerBoxColor,qa=s(y.options.fillOpacity)?1:y.fillOpacity,Q=y.dataPointIds[l];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,x1:C,y1:h,x2:A,y2:k,x3:v,y3:n,x4:v,y4:p,y5:q,borderThickness:x,color:e,stemThickness:aa,stemColor:la,whiskerThickness:O,whiskerLength:$,whiskerColor:S,
lineThickness:K,lineColor:J};c.save();0<aa&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=aa,c.setLineDash&&c.setLineDash(N(I,aa)),c.moveTo(v-G,k),c.lineTo(v-G,h),c.stroke(),c.moveTo(v-G,p),c.lineTo(v-G,n),c.stroke());c.restore();b.lineWidth=Math.max(x,4);c.beginPath();ba(c,C,Math.min(q,k),A,Math.max(k,q),va,0,e,m?F:!1,m?!1:F,!1,!1,qa);c.beginPath();ba(c,C,Math.min(n,q),A,Math.max(q,n),T,0,e,m?!1:F,m?F:!1,!1,!1,qa);c.beginPath();c.lineWidth=x;c.strokeStyle=e;c.rect(C-D,Math.min(k,n)-D,A-C+2*D,Math.max(k,
n)-Math.min(k,n)+2*D);c.stroke();c.save();0<K&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(P,K)),c.strokeStyle=J,c.lineWidth=K,c.moveTo(C,q-L),c.lineTo(A,q-L),c.stroke());c.restore();c.save();0<O&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(E,O)),c.strokeStyle=S,c.lineWidth=O,c.moveTo(v-$/2<<0,p-ea),c.lineTo(v+$/2<<0,p-ea),c.stroke(),c.moveTo(v-$/2<<0,h+ea),c.lineTo(v+$/2<<0,h+ea),c.stroke());c.restore();u&&(e=R(Q),b.strokeStyle=e,b.lineWidth=aa,0<aa&&(b.moveTo(v-D-G,k),b.lineTo(v-
D-G,Math.max(h,p)),b.stroke(),b.moveTo(v-D-G,Math.min(h,p)),b.lineTo(v-D-G,n),b.stroke()),ba(b,C,Math.max(k,n),A,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<O&&(b.beginPath(),b.lineWidth=O,b.moveTo(v+$/2,p-ea),b.lineTo(v-$/2,p-ea),b.stroke(),b.moveTo(v+$/2,h+ea),b.lineTo(v-$/2,h+ea),b.stroke()));(z[l].indexLabel||y.indexLabel||z[l].indexLabelFormatter||y.indexLabelFormatter)&&this._indexLabels.push({chartType:y.type,dataPoint:z[l],dataSeries:y,point:{x:C+(A-C)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:C,
y1:Math.min(h,p),x2:A,y2:Math.max(h,p)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,
dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,v,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
...
f));k<f&&(k=f);k>l&&(k=l);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var p=a.dataSeriesIndexes[n],q=this.data[p],g=q.dataPoints;if(0<g.length)for(var r=5<k&&q.bevelEnabled?!0:!1,f=0;f<g.length;f++)if(g[f].getTime?h=g[f].x.getTime():h=g[f].x,!(h<a.axisX.dataInfo.viewPortMin||
h>a.axisX.dataInfo.viewPortMax)&&!s(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(h);l=a.axisY.convertValueToPixel(g[f].y[0]);v=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+n)*k<<0,w=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>v){var t=l;l=
v;v=t}t=q.dataPointIds[f];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:w,y2:v};ba(c,m,l,w,v,b,0,b,r,r,!1,!1,q.fillOpacity);b=R(t);u&&ba(this._eventManager.ghostCtx,m,l,w,v,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?v:l},direction:g[f].y[1]>=g[f].y[0]?
-1:1,bounds:{x1:m,y1:Math.min(l,v),x2:w,y2:Math.max(l,v)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?l:v},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,v),x2:w,y2:Math.max(l,v)},color:b})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&w||w++;for(var y=0;y<a.dataSeriesIndexes.length;y++){var z=a.dataSeriesIndexes[y],F=this.data[z],C=F.dataPoints,A=s(F._linkedSeries)?!1:F._linkedSeries.type.match(/(bar|column)/ig)&&F._linkedSeries.visible?!0:!1,D=0;if(A)for(e=F._linkedSeries.id,t=0;t<e;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&D||(this.data[t].type.match(/(range)/ig)&&(f=!0),D++);e=this.options.dataPointMinWidth?
this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;v=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(A?w:1)))<<0:0.3*this.width;f&&(v=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(A?w:1)))<<0:0.03*this.width);t=this.options.dataPointWidth?this.dataPointWidth:
0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(A?w:1))<<0;this.dataPointMaxWidth&&e>v&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,v));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&v<e)&&(v=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&(t=e);t>v&&(t=v);if(0<C.length)for(var E=F._colorSet,v=0;v<C.length;v++){var e=F.lineColor=F.options.color?F.options.color:E[0],S={color:C[v].whiskerColor?
C[v].whiskerColor:C[v].color?F.whiskerColor?F.whiskerColor:C[v].color:F.whiskerColor?F.whiskerColor:e,thickness:s(C[v].whiskerThickness)?F.whiskerThickness:C[v].whiskerThickness,dashType:C[v].whiskerDashType?C[v].whiskerDashType:F.whiskerDashType,length:s(C[v].whiskerLength)?s(F.options.whiskerLength)?t:F.options.whiskerLength:C[v].whiskerLength,trimLength:s(C[v].whiskerLength)?s(F.options.whiskerLength)?50:0:0};S.length="number"===typeof S.length?0>=S.length?0:S.length>=t?t:S.length:"string"===typeof S.length?
parseInt(S.length)*t/100>t?t:parseInt(S.length)*t/100>t:t;S.thickness="number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;var O={color:C[v].stemColor?C[v].stemColor:C[v].color?F.stemColor?F.stemColor:C[v].color:F.stemColor?F.stemColor:e,thickness:C[v].stemThickness?C[v].stemThickness:F.stemThickness,dashType:C[v].stemDashType?C[v].stemDashType:F.stemDashType};O.thickness="number"===typeof O.thickness?0>O.thickness?0:Math.round(O.thickness):2;C[v].getTime?r=C[v].x.getTime():r=C[v].x;
if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(C[v].y)&&C[v].y.length&&"number"===typeof C[v].y[0]&&"number"===typeof C[v].y[1]){var ia=a.axisX.convertValueToPixel(r);b?k=ia:h=ia;ia=a.axisY.convertValueToPixel(C[v].y[0]);b?n=ia:q=ia;ia=a.axisY.convertValueToPixel(C[v].y[1]);b?p=ia:g=ia;b?(q=a.axisX.reversed?k+(A?w:1)*t/2-(A?D-1:0)*t<<0:k-(A?w:1)*t/2+(A?D-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?h+(A?w:1)*t/2-(A?D-1:0)*t<<0:h-(A?w:1)*t/2+(A?D-1:0)*t<<
0,p=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ia=q,q=g,g=ia);b&&n>p&&(ia=n,n=p,p=ia);ia=F.dataPointIds[v];this._eventManager.objectMap[ia]={id:ia,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:v,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:O,whiskerProperties:S};x(c,Math.min(n,p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,S,O,b);u&&x(this._eventManager.ghostCtx,n,q,p,g,e,S,O,b);if(C[v].indexLabel||F.indexLabel||C[v].indexLabelFormatter||
F.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:C[v],dataSeries:F,indexKeyword:0,point:{x:b?C[v].y[1]>=C[v].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:C[v].y[1]>=C[v].y[0]?g:q},direction:C[v].y[1]>=C[v].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:C[v],dataSeries:F,indexKeyword:1,point:{x:b?C[v].y[1]>=C[v].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:C[v].y[1]>=
C[v].y[0]?q:g},direction:C[v].y[1]>=C[v].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,v,h,k,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?
...
l&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=f);n>l&&(n=l);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=
...
n/2-(a.previousDataSeriesCount+p)*n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var w=a.axisX.reversed?h-n<<0:h+n<<0;l>v&&(b=l,l=v,v=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ba(c,l,h,v,w,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:v,y2:w};b=R(b);u&&ba(this._eventManager.ghostCtx,l,h,v,w,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||
r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:v,y:h+(w-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,v),y1:h,x2:Math.max(l,v),y2:w},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=r[f].y[0]?v:l,y:h+(w-h)/2},direction:r[f].y[1]>=r[f].y[0]?1:-1,bounds:{x1:Math.min(l,v),y1:h,x2:Math.max(l,v),y2:w},
...
animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(y){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();
b.moveTo(r,m);e.beginPath();e.moveTo(r,m);y={x:r,y:m};h=[];h.push({x:r,y1:m,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var h=[],k=a.dataSeriesIndexes[v],n=this.data[k],p=n.dataPoints,f=n.id;
this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=R(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,t,y=null;if(0<p.length){var z=n._colorSet[g%n._colorSet.length],w=n.lineColor=n.options.lineColor||z,C=w;b.fillStyle=z;b.strokeStyle=w;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=N(n.nullDataLineDashType,n.lineThickness),A=n.lineDashType,D=N(A,n.lineThickness);b.setLineDash(D)}for(var S=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||
t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!S)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(t);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||S?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||A===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=D,A=n.nullDataLineDashType,b.setLineDash(x)),b.lineTo(r,m),u&&e.lineTo(r,
m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),y={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),u&&(e.beginPath(),e.moveTo(r,m))),S=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),u&&e.lineTo(r,m),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-1&&(C!==(p[g].lineColor||w)||A!==(p[g].lineDashType||n.lineDashType))&&(d(),C=p[g].lineColor||w,h[h.length-1].newStrokeStyle=C,b.strokeStyle=C,b.setLineDash&&
(p[g].lineDashType?(A=p[g].lineDashType,h[h.length-1].newLineDashArray=N(A,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(A=n.lineDashType,h[h.length-1].newLineDashArray=D,b.setLineDash(D))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var O=n.getMarkerProperties(g,r,s,b);f.push(O);var E=R(t);u&&f.push({x:r,y:s,ctx:e,type:O.type,size:O.size,color:E,borderColor:E,borderThickness:O.borderThickness});O=n.getMarkerProperties(g,r,m,b);f.push(O);E=R(t);u&&f.push({x:r,
y:m,ctx:e,type:O.type,size:O.size,color:E,borderColor:E,borderThickness:O.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:z}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,
color:z})}else S||q||d(),S=!0;d();W.drawMarkers(f)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());
...
d[f].newLineDashArray&&b.setLineDash(d[f].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}}b.beginPath();b.moveTo(d[0].x,d[0].y);u&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),u&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=w(x,2);b.lineTo(x[x.length-1].x,x[x.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,
d[f-2].y,d[f-3].x,d[f-3].y),u&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();u&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(s[g].newStrokeStyle||s[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),s[g].newStrokeStyle&&(b.strokeStyle=s[g].newStrokeStyle),s[g].newLineDashArray&&
...
this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var m=a.dataSeriesIndexes[h],k=this.data[m],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:m};f=R(f);e.fillStyle=f;var f=[],p=0,q,
g,r,s=[],x=[];if(0<n.length){var t=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||t,z=y;b.fillStyle=t;b.lineWidth=k.lineThickness;var F="solid",C;if(b.setLineDash){var A=N(k.nullDataLineDashType,k.lineThickness),F=k.lineDashType;C=N(F,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===
typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var D=k.dataPointIds[p];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:q,y1:g,y2:r};s[s.length]={x:q,y:g};x[x.length]={x:q,y:r};p<n.length-1&&(z!==(n[p].lineColor||y)||F!==(n[p].lineDashType||k.lineDashType))&&(z=n[p].lineColor||y,s[s.length-1].newStrokeStyle=z,b.setLineDash&&(n[p].lineDashType?(F=n[p].lineDashType,
s[s.length-1].newLineDashArray=N(F,k.lineThickness)):(F=k.lineDashType,s[s.length-1].newLineDashArray=C)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var E=k.getMarkerProperties(p,q,g,b);f.push(E);var S=R(D);u&&f.push({x:q,y:g,ctx:e,type:E.type,size:E.size,color:S,borderColor:S,borderThickness:E.borderThickness});E=k.getMarkerProperties(p,q,r,b);f.push(E);S=R(D);u&&f.push({x:q,y:r,ctx:e,type:E.type,size:E.size,color:S,borderColor:S,borderThickness:E.borderThickness})}if(n[p].indexLabel||
...
1].newLineDashArray=A,F=k.nullDataLineDashType):(d(C,y),s=[],x=[])),g=!0;d(C,y);W.drawMarkers(f)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,l=0,h,m,k,n,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.options.dataPointMinWidth?this.dataPointMinWidth:
...
l>m&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<l)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>m&&(q=m);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var r=
a.dataSeriesIndexes[g],s=this.data[r],w=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var t="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,y=1===Math.round(t)%2?-0.5:0;if(0<w.length)for(var z=5<q&&s.bevelEnabled?!0:!1,F=!1,x=null,A=null,l=0;l<w.length;l++)if(w[l].getTime?n=w[l].x.getTime():n=w[l].x,"number"!==typeof w[l].y){if(0<l&&!F&&s.connectNullData)var D=
s.options.nullDataLineDashType||!w[l-1].lineDashType?s.nullDataLineDashType:w[l-1].lineDashType;F=!0}else{h=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+
g)*q<<0;var E=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:E,y2:k};var S=w[l].color?w[l].color:0<w[l].y?s.risingColor:s.fallingColor;ba(c,h,m,E,k,S,0,S,z,z,!1,!1,s.fillOpacity);e=R(e);u&&ba(this._eventManager.ghostCtx,h,m,E,k,e,0,null,!1,!1,!1,!1);var O,S=h;O="undefined"!==typeof w[l].isIntermediateSum&&!0===w[l].isIntermediateSum||"undefined"!==
typeof w[l].isCumulativeSum&&!0===w[l].isCumulativeSum?0<w[l].y?m:k:0<w[l].y?k:m;0<l&&x&&(!F||s.connectNullData)&&(F&&c.setLineDash&&c.setLineDash(N(D,t)),c.beginPath(),c.moveTo(x,A-y),c.lineTo(S,O-y),0<t&&c.stroke(),u&&(b.beginPath(),b.moveTo(x,A-y),b.lineTo(S,O-y),0<t&&b.stroke()));F=!1;x=E;A=0<w[l].y?m:k;S=w[l].lineDashType?w[l].lineDashType:s.options.lineDashType?s.options.lineDashType:"shortDash";c.strokeStyle=w[l].lineColor?w[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=
t;c.setLineDash&&(S=N(S,t),c.setLineDash(S));(w[l].indexLabel||s.indexLabel||w[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:w[l],dataSeries:s,point:{x:h+(E-h)/2,y:0<=w[l].y?m:k},direction:0>w[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(m,k),x2:E,y2:Math.max(m,k)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};var Y=function(a,d,c,b,e,f,l,h,m){if(!(0>c)){"undefined"===typeof h&&
(h=1);if(!u){var k=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,l,!1),0<=m&&a.arc(d.x,d.y,m*c,l,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.fill());a.globalAlpha=1;a.restore()}};m.prototype.renderPie=function(a){function d(){if(k&&
n){for(var a=0,b=0,c=0,d=0,e=0;e<n.length;e++){var f=n[e],l=k.dataPointIds[e];g[e].id=l;g[e].objectType="dataPoint";g[e].dataPointIndex=e;g[e].dataSeriesIndex=0;var p=g[e],h={percent:null,total:null},v=null,h=m.getPercentAndTotal(k,f);if(k.indexLabelFormatter||f.indexLabelFormatter)v={chart:m.options,dataSeries:k,dataPoint:f,total:h.total,percent:h.percent};h=f.indexLabelFormatter?f.indexLabelFormatter(v):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(v):
k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=p;p.center={x:z.x,y:z.y};p.y=f.y;p.radius=A;p.percentInnerRadius=E;p.indexLabelText=h;p.indexLabelPlacement=k.indexLabelPlacement;p.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%k._colorSet.length];p.indexLabelLineThickness=s(f.indexLabelLineThickness)?k.indexLabelLineThickness:f.indexLabelLineThickness;
p.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:k.indexLabelLineDashType;p.indexLabelFontColor=f.indexLabelFontColor?f.indexLabelFontColor:k.indexLabelFontColor;p.indexLabelFontStyle=f.indexLabelFontStyle?f.indexLabelFontStyle:k.indexLabelFontStyle;p.indexLabelFontWeight=f.indexLabelFontWeight?f.indexLabelFontWeight:k.indexLabelFontWeight;p.indexLabelFontSize=s(f.indexLabelFontSize)?k.indexLabelFontSize:f.indexLabelFontSize;p.indexLabelFontFamily=f.indexLabelFontFamily?
f.indexLabelFontFamily:k.indexLabelFontFamily;p.indexLabelBackgroundColor=f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:k.options.indexLabelBackgroundColor?k.options.indexLabelBackgroundColor:k.indexLabelBackgroundColor;p.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:k.indexLabelMaxWidth?k.indexLabelMaxWidth:0.33*q.width;p.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?f.indexLabelWrap:k.indexLabelWrap;p.indexLabelTextAlign=f.indexLabelTextAlign?f.indexLabelTextAlign:
k.indexLabelTextAlign?k.indexLabelTextAlign:"left";p.startAngle=0===e?k.startAngle?k.startAngle/180*Math.PI:0:g[e-1].endAngle;p.startAngle=(p.startAngle+2*Math.PI)%(2*Math.PI);p.endAngle=p.startAngle+2*Math.PI/F*Math.abs(f.y);f=(p.endAngle+p.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);p.midAngle=f;if(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>p.midAngle)c=e;a++}else if(p.midAngle>3*Math.PI/2-t&&p.midAngle<3*Math.PI/2+t){if(0===b||g[d].midAngle>p.midAngle)d=e;b++}p.hemisphere=
f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";p.indexLabelTextBlock=new ha(m.plotArea.ctx,{fontSize:p.indexLabelFontSize,fontFamily:p.indexLabelFontFamily,fontColor:p.indexLabelFontColor,fontStyle:p.indexLabelFontStyle,fontWeight:p.indexLabelFontWeight,textAlign:p.indexLabelTextAlign,backgroundColor:p.indexLabelBackgroundColor,maxWidth:p.indexLabelMaxWidth,maxHeight:p.indexLabelWrap?5*p.indexLabelFontSize:1.5*p.indexLabelFontSize,text:p.indexLabelText,padding:0,textBaseline:"top"});p.indexLabelTextBlock.measureText()}l=
f=0;h=!1;for(e=0;e<n.length;e++)p=g[(c+e)%n.length],1<a&&(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t)&&(f<=a/2&&!h?(p.hemisphere="right",f++):(p.hemisphere="left",h=!0));h=!1;for(e=0;e<n.length;e++)p=g[(d+e)%n.length],1<b&&(p.midAngle>3*Math.PI/2-t&&p.midAngle<3*Math.PI/2+t)&&(l<=b/2&&!h?(p.hemisphere="left",l++):(p.hemisphere="right",h=!0))}}function c(a){var b=m.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(b=0;b<
...
e-d:c-f}function e(a){for(var c=null,d=1;d<n.length;d++)if(c=(a+d+g.length)%g.length,g[c].hemisphere!==g[a].hemisphere){c=null;break}else if(g[c].indexLabelText&&c!==a&&(0>b(g[c],g[a])||("right"===g[a].hemisphere?g[c].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y:g[c].indexLabelTextBlock.y<=g[a].indexLabelTextBlock.y)))break;else c=null;return c}function f(a,c,d){d=(d||0)+1;if(1E3<d)return 0;c=c||0;var k=0,l=z.y-1*u,p=z.y+1*u;if(0<=a&&a<n.length){var h=g[a];if(0>c&&h.indexLabelTextBlock.y<l||
0<c&&h.indexLabelTextBlock.y>p)return 0;var q=0,m=0,m=q=q=0;0>c?h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2>l&&h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2+c<l&&(c=-(l-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2+c))):h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2<l&&h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+c>p&&(c=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+c-p);c=h.indexLabelTextBlock.y+c;l=0;l="right"===h.hemisphere?z.x+Math.sqrt(Math.pow(u,
2)-Math.pow(c-z.y,2)):z.x-Math.sqrt(Math.pow(u,2)-Math.pow(c-z.y,2));m=z.x+A*Math.cos(h.midAngle);q=z.y+A*Math.sin(h.midAngle);q=Math.sqrt(Math.pow(l-m,2)+Math.pow(c-q,2));m=Math.acos(A/u);q=Math.acos((u*u+A*A-q*q)/(2*A*u));c=q<m?c-h.indexLabelTextBlock.y:0;l=null;for(p=1;p<n.length;p++)if(l=(a-p+g.length)%g.length,g[l].hemisphere!==g[a].hemisphere){l=null;break}else if(g[l].indexLabelText&&g[l].hemisphere===g[a].hemisphere&&l!==a&&(0>b(g[l],g[a])||("right"===g[a].hemisphere?g[l].indexLabelTextBlock.y<=
g[a].indexLabelTextBlock.y:g[l].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y)))break;else l=null;m=l;q=e(a);p=l=0;0>c?(p="right"===h.hemisphere?m:q,k=c,null!==p&&(m=-c,c=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-(g[p].indexLabelTextBlock.y+g[p].indexLabelTextBlock.height/2),c-m<r&&(l=-m,p=f(p,l,d+1),+p.toFixed(y)>+l.toFixed(y)&&(k=c>r?-(c-r):-(m-(p-l)))))):0<c&&(p="right"===h.hemisphere?q:m,k=c,null!==p&&(m=c,c=g[p].indexLabelTextBlock.y-g[p].indexLabelTextBlock.height/2-(h.indexLabelTextBlock.y+
h.indexLabelTextBlock.height/2),c-m<r&&(l=m,p=f(p,l,d+1),+p.toFixed(y)<+l.toFixed(y)&&(k=c>r?c-r:m-(l-p)))));k&&(d=h.indexLabelTextBlock.y+k,c=0,c="right"===h.hemisphere?z.x+Math.sqrt(Math.pow(u,2)-Math.pow(d-z.y,2)):z.x-Math.sqrt(Math.pow(u,2)-Math.pow(d-z.y,2)),h.midAngle>Math.PI/2-t&&h.midAngle<Math.PI/2+t?(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"left"===h.hemisphere&&"right"===l.hemisphere&&c>l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x-15:"right"===h.hemisphere&&("left"===
...
z.y,h.indexLabelTextBlock.x-z.x))}return k}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&A-d<=D)l=!1;l&&(A-=d);d=0;if("inside"!==k.indexLabelPlacement){u=A*w;for(a=0;a<n.length;a++){var h=g[a];h.indexLabelTextBlock.x=z.x+u*Math.cos(h.midAngle);h.indexLabelTextBlock.y=z.y+u*Math.sin(h.midAngle);h.indexLabelAngle=
h.midAngle;h.radius=A;h.percentInnerRadius=E}for(var v,s,a=0;a<n.length;a++){var h=g[a],t=e(a);if(null!==t){v=g[a];s=g[t];var F=0,F=b(v,s)-r;if(0>F){for(var x=s=0,C=0;C<n.length;C++)C!==a&&g[C].hemisphere===h.hemisphere&&(g[C].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:x++);s=F/(s+x||1)*x;var x=-1*(F-s),I=C=0;"right"===h.hemisphere?(C=f(a,s),x=-1*(F-C),I=f(t,x),+I.toFixed(y)<+x.toFixed(y)&&+C.toFixed(y)<=+s.toFixed(y)&&f(a,-(x-I))):(C=f(t,s),x=-1*(F-C),I=f(a,x),+I.toFixed(y)<+x.toFixed(y)&&
+C.toFixed(y)<=+s.toFixed(y)&&f(t,-(x-I)))}}}}else for(a=0;a<n.length;a++)h=g[a],u="pie"===k.type?0.7*A:0.8*A,t=z.x+u*Math.cos(h.midAngle),s=z.y+u*Math.sin(h.midAngle),h.indexLabelTextBlock.x=t,h.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(h=g[a],t=h.indexLabelTextBlock.measureText(),0!==t.height&&0!==t.width)t=t=0,"right"===h.hemisphere?(t=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+p),t*=-1):t=q.x1-(h.indexLabelTextBlock.x-h.indexLabelTextBlock.width-p),0<t&&(!l&&h.indexLabelText&&
...
h.indexLabelAngle<Math.PI?(t=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),t*=-1):t=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<t&&(!l&&h.indexLabelText&&(s=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===f(a,t*s)&&f(a,2*s)),Math.abs(h.indexLabelTextBlock.x-z.x)<A&&(t/=Math.abs(Math.sin(h.indexLabelAngle)),9<t&&(t*=0.3),t>d&&(d=t)));var L=function(a,b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+n.length)%n.length);d.sort(function(a,b){return a.y-b.y});
for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,k=0;k<n.length;k++)if(f=!1,v=g[k],v.indexLabelText){var l=e(k);if(null!==l){var h=g[l];F=0;F=b(v,h);var q;if(q=0>F){q=v.indexLabelTextBlock.x;var m=v.indexLabelTextBlock.y-v.indexLabelTextBlock.height/2,r=v.indexLabelTextBlock.y+v.indexLabelTextBlock.height/2,t=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/
2,s=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,B=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=v.indexLabelTextBlock.x+v.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>s+p||m>B+p||r<t-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-F),0===k%Math.max(n.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(L(d,a,c),c=a=-1,d=0)}}0<d&&L(d,a,c)})()}}function h(){m.plotArea.layoutManager.reset();m.title&&(m.title.dockInsidePlotArea||"center"===m.title.horizontalAlign&&"center"===m.title.verticalAlign)&&
m.title.render();if(m.subtitles)for(var a=0;a<m.subtitles.length;a++){var b=m.subtitles[a];(b.dockInsidePlotArea||"center"===b.horizontalAlign&&"center"===b.verticalAlign)&&b.render()}m.legend&&(m.legend.dockInsidePlotArea||"center"===m.legend.horizontalAlign&&"center"===m.legend.verticalAlign)&&(m.legend.setLayout(),m.legend.render())}var m=this;if(!(0>=a.dataSeriesIndexes.length)){var k=this.data[a.dataSeriesIndexes[0]],n=k.dataPoints,p=10,q=this.plotArea,g=k.dataPointEOs,r=2,u,w=1.3,t=20/180*Math.PI,
y=6,z={x:(q.x2+q.x1)/2,y:(q.y2+q.y1)/2},F=0;a=!1;for(var x=0;x<n.length;x++)F+=Math.abs(n[x].y),!a&&("undefined"!==typeof n[x].indexLabel&&null!==n[x].indexLabel&&0<n[x].indexLabel.toString().length)&&(a=!0),!a&&("undefined"!==typeof n[x].label&&null!==n[x].label&&0<n[x].label.toString().length)&&(a=!0);if(0!==F){a=a||"undefined"!==typeof k.indexLabel&&null!==k.indexLabel&&0<k.indexLabel.toString().length;var A="inside"!==k.indexLabelPlacement&&a?0.75*Math.min(q.width,q.height)/2:0.92*Math.min(q.width,
q.height)/2;k.radius&&(A=Sa(k.radius,A));var D="undefined"!==typeof k.innerRadius&&null!==k.innerRadius?Sa(k.innerRadius,A):0.7*A;k.radius=A;"doughnut"===k.type&&(k.innerRadius=D);var E=Math.min(D/A,(A-1)/A);this.pieDoughnutClickHandler=function(a){m.isAnimating||!s(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&m._animator.animate(0,500,function(a){c(a);h();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});m.dispatchEvent("dataAnimationEnd",
...
typeof y[c].y?y[c].y:0;a+=Math.abs(y[c].y)}if(0===a)return-1;for(c=b[0]=0;c<y.length;c++)b.push(Math.abs(y[c].y)*D/a);return b}function c(){var a=U,b=X,c=L,d=W,e,f;e=K;f=P-aa;d=Math.abs((f-e)*(b-a+(d-c))/2);c=W-L;e=f-e;f=c*(f-P);f=Math.abs(f);f=d+f;for(var d=[],g=0,k=0;k<y.length;k++){if("undefined"===typeof y[k].y)return-1;y[k].y="number"===typeof y[k].y?y[k].y:0;g+=Math.abs(y[k].y)}if(0===g)return-1;for(var l=d[0]=0,n=0,h,p,b=b-a,l=!1,k=0;k<y.length;k++)a=Math.abs(y[k].y)*f/g,l?h=0==Number(c.toFixed(3))?
0:a/c:(p=Z*Z*b*b-4*Math.abs(Z)*a,0>p?(p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=0==p?0:a/p,n+=a/p,l=!0):(h=(Math.abs(Z)*b-Math.sqrt(p))/2,p=b-2*h/Math.abs(Z),n+=h,n>e&&(n-=h,p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=a/p,n+=a/p,l=!0),b=p)),d.push(h);return d}function b(){if(t&&y){for(var a,b,c,d,e,f,k,l,n,h,p,q,m,v,r,B=[],w=[],z={percent:null,total:null},F=null,A=0;A<y.length;A++)r=Q[A],r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,B[A]=J-r-T;r=0.5*T;for(var A=0,C=y.length-1;A<
y.length||0<=C;A++,C--){b=t.reversed?y[C]:y[A];a=b.color?b.color:t.reversed?t._colorSet[(y.length-1-A)%t._colorSet.length]:t._colorSet[A%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";v=b.indexLabelTextAlign||t.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(u?"transparent":null);e=b.indexLabelFontColor||t.indexLabelFontColor||"#979797";f=s(b.indexLabelFontSize)?t.indexLabelFontSize:b.indexLabelFontSize;k=b.indexLabelFontStyle||
t.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||t.indexLabelFontFamily||"arial";n=b.indexLabelFontWeight||t.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||t.options.indexLabelLineColor||a;h="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof t.indexLabelLineThickness?t.indexLabelLineThickness:2;p=b.indexLabelLineDashType||t.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?
t.indexLabelWrap:!0;m=t.dataPointIds[A];x._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:Q[t.reversed?y.length-1-A:A]};"inside"===t.indexLabelPlacement&&(B[A]=A!==ba?t.reversed?Q[A].x2-Q[A].x1:Q[A].x3-Q[A].x4:Q[A].x3-Q[A].x6,20>B[A]&&(B[A]=A!==ba?t.reversed?Q[A].x3-Q[A].x4:Q[A].x2-Q[A].x1:Q[A].x2-Q[A].x1,B[A]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:B[A];if(m>B[A]||0>m)m=B[A];w[A]="inside"===
t.indexLabelPlacement?Q[A].height:!1;z=x.getPercentAndTotal(t,b);if(t.indexLabelFormatter||b.indexLabelFormatter)F={chart:x.options,dataSeries:t,dataPoint:b,total:z.total,percent:z.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(F):b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,t,A):t.indexLabelFormatter?t.indexLabelFormatter(F):t.indexLabel?x.replaceKeywordsWithValue(t.indexLabel,b,t,A):b.label?b.label:"";0>=h&&(h=0);1E3>m&&1E3-m<r&&(m+=1E3-m);R.roundRect||Aa(R);c=new ha(R,{fontSize:f,
fontFamily:l,fontColor:e,fontStyle:k,fontWeight:n,horizontalAlign:c,textAlign:v,backgroundColor:d,maxWidth:m,maxHeight:!1===w[A]?q?4.28571429*f:1.5*f:w[A],text:b,padding:ca});c.measureText();H.push({textBlock:c,id:t.reversed?C:A,isDirty:!1,lineColor:a,lineThickness:h,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=J-X-T/2,k=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>k?k:t.indexLabelMaxWidth:
...
H[l].height=c,H[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,H[l].textBlock.y=c-H[l].height/2,t.reversed?(H[l].textBlock.y+H[l].height>ma+F&&(H[l].textBlock.y=ma+F-H[l].height),H[l].textBlock.y<qa-F&&(H[l].textBlock.y=qa-F)):(H[l].textBlock.y<ma-F&&(H[l].textBlock.y=ma-F),H[l].textBlock.y+H[l].height>qa+F&&(H[l].textBlock.y=qa+F-H[l].height))}function f(){var a,b,c,d;if("inside"!==t.indexLabelPlacement)for(var e=0;e<Q.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:
(a=Q[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=t.reversed?"undefined"!==typeof a.x5?c>va?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<va?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,H[e].textBlock.x=b+T,H[e].textBlock.y=c-H[e].height/2,t.reversed?(H[e].textBlock.y+H[e].height>ma+F&&(H[e].textBlock.y=ma+F-H[e].height),H[e].textBlock.y<qa-F&&(H[e].textBlock.y=qa-F)):(H[e].textBlock.y<ma-F&&(H[e].textBlock.y=ma-F),H[e].textBlock.y+H[e].height>qa+F&&(H[e].textBlock.y=
qa+F-H[e].height)));else for(e=0;e<Q.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=Q[e],b=a.height,c=H[e].height,d=H[e].width,b>=c?(b=e!=ba?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ba?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,H[e].textBlock.x=b,H[e].textBlock.y=c):H[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=H.length)return 0;var e,f=H[b].textBlock;if(0>c){c*=-1;e=p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=
q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==Q.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,k;f=(P-K+2*F)/n;k=n;for(var l,h=1;h<k;h++){e=h*f;for(var m=H.length-1;0<=m;m--)!H[m].isDirty&&(H[m].textBlock.y<e&&H[m].textBlock.y+H[m].height>e)&&(l=q(m),!(l>=H.length-1)&&H[m].textBlock.y+H[m].height+ca>H[l].textBlock.y&&(H[m].textBlock.y=H[m].textBlock.y+H[m].height-e>e-H[m].textBlock.y?e+1:e-H[m].height-1))}for(l=Q.length-1;0<l;l--)if(!H[l].isDirty){e=
...
e[d],f<a)g++,f+=H[b.id].height+ca,H[b.id].textBlock.text="",H[b.id].indexLabelText="",H[b.id].isDirty=!0,H[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,k,l,n=1,m=0;m<2*n;m++){for(var r=H.length-1;0<=r&&!(0<=p(r)&&p(r),f=H[r],g=f.textBlock,l=(k=q(r)<Q.length?H[q(r)]:null)?k.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(k&&e+d+ca>+l.y.toFixed(6))&&(d=g.y+d+ca-l.y,e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<Q.length?H[b].textBlock.y:
t.reversed?ma+F:qa+F)-(0>a?t.reversed?qa-F:ma-F:H[a].textBlock.y+H[a].height+ca)}function m(a,b,c){var d,e,g,l=[],h=F,p=[];-1!==b&&(0<=Y.indexOf(b)?(e=Y.indexOf(b),Y.splice(e,1)):(Y.push(b),Y=Y.sort(function(a,b){return a-b})));if(0===Y.length)l=fa;else{e=F*(1!=Y.length||0!=Y[0]&&Y[0]!=Q.length-1?2:1)/k();for(var q=0;q<Q.length;q++){if(1==Y.length&&0==Y[0]){if(0===q){l.push(fa[q]);d=h;continue}}else 0===q&&(d=-1*h);l.push(fa[q]+d);if(0<=Y.indexOf(q)||q<Q.length&&0<=Y.indexOf(q+1))d+=e}}g=function(){for(var a=
[],b=0;b<Q.length;b++)a.push(l[b]-Q[b].y1);return a}();var v={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return M.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<Q.length;d++)b=g[d],c=Q[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ga=!0;d.clearRect(z.x1,z.y1,z.x2-z.x1,
z.y2-z.y1);d.fillStyle=a.backgroundColor;d.fillRect(z.x1,z.y1,z.width,z.height);v.changeSection(c,b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[y.length-1-b]:t.dataPoints[b];e.index=t.reversed?y.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<Q.length;e++)pa(d,Q[e],t.fillOpacity);w(d);I&&("inside"!==t.indexLabelPlacement?n(d):f(),r(d));1<=c&&(ga=!1)},null,M.easing.easeOutQuart)}function k(){for(var a=0,b=0;b<Q.length-1;b++)(0<=Y.indexOf(b)||0<=Y.indexOf(b+1))&&a++;return a}
...
a!=Q.length&&H[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<y.length;c++)if(Q[c].y1<a&&Q[c].y4>a){b=Q[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<Q.length;b++)H[b].isDirty||(a&&(H[b].textBlock.ctx=a),H[b].textBlock.render(!0))}function w(a){x.plotArea.layoutManager.reset();a.roundRect||Aa(a);x.title&&(x.title.dockInsidePlotArea||"center"===x.title.horizontalAlign&&
...
y=t.dataPoints,z=this.plotArea,F=0.025*z.width,C=0.01*z.width,A=0,D=z.height-2*F,E=Math.min(z.width-2*C,2.8*z.height),I=!1,O=0;O<y.length;O++)if(!I&&("undefined"!==typeof y[O].indexLabel&&null!==y[O].indexLabel&&0<y[O].indexLabel.toString().length)&&(I=!0),!I&&("undefined"!==typeof y[O].label&&null!==y[O].label&&0<y[O].label.toString().length)&&(I=!0),!I&&"function"===typeof t.indexLabelFormatter||"function"===typeof y[O].indexLabelFormatter)I=!0;I=I||"undefined"!==typeof t.indexLabel&&null!==t.indexLabel&&
0<t.indexLabel.toString().length;"inside"!==t.indexLabelPlacement&&I||(C=(z.width-0.75*E)/2);var O=z.x1+C,J=z.x2-C,K=z.y1+F,P=z.y2-F,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==y.length){var aa,G;a=75*E/100;var T=30*(J-a)/100;"funnel"===t.type?(aa=s(t.options.neckHeight)?0.35*D:t.neckHeight,G=s(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===typeof aa&&aa.match(/%$/)?(aa=parseInt(aa),aa=aa*D/100):aa=parseInt(aa),"string"===typeof G&&G.match(/%$/)?
(G=parseInt(G),G=G*a/100):G=parseInt(G),aa>D?aa=D:0>=aa&&(aa=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===t.type&&(G=aa=0,t.reversed=t.reversed?!1:!0);var C=O+a/2,U=O,X=O+a,ma=t.reversed?P:K,L=C-G/2,W=C+G/2,va=t.reversed?K+aa:P-aa,qa=t.reversed?K:P;a=[];var C=[],Q=[],E=[],V=K,ba,Z=(va-ma)/(L-U),da=-Z,O="area"===(t.valueRepresents?t.valueRepresents:"height")?c():d();if(-1!==O){if(t.reversed)for(E.push(V),G=O.length-1;0<G;G--)V+=O[G],E.push(V);else for(G=0;G<O.length;G++)V+=O[G],E.push(V);if(t.reversed)for(G=
0;G<O.length;G++)E[G]<va?(a.push(L),C.push(W),ba=G):(a.push((E[G]-ma+Z*U)/Z),C.push((E[G]-ma+da*X)/da));else for(G=0;G<O.length;G++)E[G]<va?(a.push((E[G]-ma+Z*U)/Z),C.push((E[G]-ma+da*X)/da),ba=G):(a.push(L),C.push(W));for(G=0;G<O.length-1;G++)V=t.reversed?y[y.length-1-G].color?y[y.length-1-G].color:t._colorSet[(y.length-1-G)%t._colorSet.length]:y[G].color?y[G].color:t._colorSet[G%t._colorSet.length],G===ba?Q.push({x1:a[G],y1:E[G],x2:C[G],y2:E[G],x3:W,y3:va,x4:C[G+1],y4:E[G+1],x5:a[G+1],y5:E[G+1],
x6:L,y6:va,id:G,height:E[G+1]-E[G],color:V}):Q.push({x1:a[G],y1:E[G],x2:C[G],y2:E[G],x3:C[G+1],y3:E[G+1],x4:a[G+1],y4:E[G+1],id:G,height:E[G+1]-E[G],color:V});var ca=2,H=[],ga=!1,Y=[],fa=[],O=!1;a=a=0;Ba(Y);for(G=0;G<y.length;G++)y[G].exploded&&(O=!0,t.reversed?Y.push(y.length-1-G):Y.push(G));R.clearRect(z.x1,z.y1,z.width,z.height);R.fillStyle=x.backgroundColor;R.fillRect(z.x1,z.y1,z.width,z.height);if(I&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){l();for(G=0;G<y.length;G++)H[G].isDirty||
(a=H[G].textBlock.x+H[G].width,a=(J-a)/2,0==G&&(A=a),A>a&&(A=a));for(G=0;G<Q.length;G++)Q[G].x1+=A,Q[G].x2+=A,Q[G].x3+=A,Q[G].x4+=A,Q[G].x5&&(Q[G].x5+=A,Q[G].x6+=A),H[G].textBlock.x+=A}for(G=0;G<Q.length;G++)A=Q[G],pa(R,A,t.fillOpacity),fa.push(A.y1);w(R);I&&t.visible&&("inside"===t.indexLabelPlacement||x.animationEnabled||n(R),x.animationEnabled||r());if(!I)for(G=0;G<y.length;G++)A=t.dataPointIds[G],a={id:A,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:Q[t.reversed?y.length-
1-G:G]},x._eventManager.objectMap[A]=a;!x.animationEnabled&&O?m(x,-1,0):x.animationEnabled&&!x.animatedRender&&m(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ga&&!x.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?y.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===t.type||"pyramid"===t.type)t.reversed?y[y.length-1-a].exploded=y[y.length-1-a].exploded?!1:!0:y[a].exploded=y[a].exploded?!1:!0;m(x,b,500)}};return{source:R,
dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(m(x,-1,500),w(x.plotArea.ctx||x.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();m.prototype.cancelRequestAnimFrame=window.cancelAnimationFrame||window.webkitCancelRequestAnimationFrame||
...
d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};na(E,I);E.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=this.chart.options.legend&&!s(this.chart.options.legend.markerMargin)?this.chart.options.legend.markerMargin:0.3*this.fontSize;this.height=0;var m=[],k=[];if("top"===this.verticalAlign||"bottom"===this.verticalAlign)this.orientation=
...
0;n<this.dataSeries.length;n++){var p=this.dataSeries[n];if(p.dataPoints&&p.dataPoints.length)if("pie"!==p.type&&"doughnut"!==p.type&&"funnel"!==p.type&&"pyramid"!==p.type){var q=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:K.getDefaultLegendMarker(p._linkedSeries.type):K.getDefaultLegendMarker(p.type):
p.markerType,g=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:null}):p.name,r=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?s(p.whiskerColor)?p._colorSet[0]:p.whiskerColor:p._colorSet[0],u=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,w=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,
t=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*u)):0;"error"===p.type&&this.errorMarkerColor.push(r);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:u,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:t};m.push(q)}else for(var y=0;y<p.dataPoints.length;y++){var z=p.dataPoints[y],q=
z.legendMarkerType?z.legendMarkerType:p.legendMarkerType?p.legendMarkerType:K.getDefaultLegendMarker(p.type),g=z.legendText?z.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:z}):z.name?z.name:"DataPoint: "+(y+1),r=z.legendMarkerColor?z.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:z.color?z.color:p.color?p.color:p._colorSet[y%p._colorSet.length],u=0.75*this.lineHeight,w=z.legendMarkerBorderColor?
z.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:z.markerBorderColor?z.markerBorderColor:p.markerBorderColor,t=z.legendMarkerBorderThickness?z.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:z.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*u)):0,g=this.chart.replaceKeywordsWithValue(g,z,p,y),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:u,dataSeriesIndex:n,dataPointIndex:y,
markerBorderColor:w,markerBorderThickness:t};(z.showInLegend||p.showInLegend&&!1!==z.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=z=y=0;z=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=f;u=0===u?0.75*this.lineHeight:u;z-=u+h;for(n=0;n<m.length;n++){q=m[n];w=z;if("line"===q.chartType||"spline"===q.chartType||
"stepLine"===q.chartType)w-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=w||"undefined"===typeof w)){if("horizontal"===this.orientation){q.textBlock=new ha(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?l:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=
this.itemWidth-(u+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!p||p.width+Math.round(q.textBlock.width+u+h+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>f)p={items:[],width:0},k.push(p),this.height+=g,g=0;g=Math.max(g,q.textBlock.height)}else q.textBlock=new ha(this.ctx,{x:0,y:0,maxWidth:z,maxHeight:!0===this.itemWrap?l:1.5*this.fontSize,angle:0,text:q.text,
horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),q.textBlock.measureText(),null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(u+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))),this.height<l-this.lineHeight?(p={items:[],width:0},k.push(p)):(p=k[y],y=(y+1)%k.length),this.height+=q.textBlock.height;q.textBlock.x=p.width;
q.textBlock.y=0;p.width+=Math.round(q.textBlock.width+u+h+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));p.items.push(q);this.width=Math.max(p.width,this.width);r=q.textBlock.width+(u+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=r;this.height=!1===this.itemWrap?k.length*this.lineHeight:this.height+g;this.height=Math.min(l,this.height);this.width=
...
this.items=m;for(n=0;n<this.items.length;n++)q=m[n],q.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[q.id]={id:q.id,objectType:"legendItem",legendItemIndex:n,dataSeriesIndex:q.dataSeriesIndex,dataPointIndex:q.dataPointIndex};this.markerSize=u;this.rows=k;0<m.length&&a.layoutManager.registerSpace(c,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:e,y1:b,x2:e+this.width,y2:b+this.height}};E.prototype.render=function(){var a=this.bounds.x1,d=this.bounds.y1,
c=this.markerMargin,b=this.maxWidth,e=this.maxHeight,f=this.markerSize,l=this.rows;(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(a,d,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var h=0,m=0;m<l.length;m++){for(var k=l[m],n=0,p=0;p<k.items.length;p++){var q=k.items[p],g=q.textBlock.x+a+(0===p?0.2*f:this.horizontalSpacing),r=d+h,s=g;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);
...
this.ctx.lineWidth=f/8;this.ctx.beginPath();var u=g-0.08*this.lineHeight+0.1*this.lineHeight,t=r+0.15*this.lineHeight,y=0.7*this.lineHeight,w=y+0.02*this.lineHeight;this.ctx.moveTo(u,t);this.ctx.lineTo(u+y,t);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(u+y/2,t);this.ctx.lineTo(u+y/2,t+w);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(u,t+w);this.ctx.lineTo(u+y,t+w);this.ctx.stroke();this.errorMarkerColor.shift()}W.drawMarker(g+f/2,r+this.lineHeight/2,this.ctx,q.markerType,"error"===
q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(r+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();n=0<p?Math.max(n,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=R(q.id);this.ghostCtx.fillStyle=
g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(s,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-s,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=s;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};na(K,I);K.prototype.getDefaultAxisPlacement=
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=ka("markerSize",g,this)||4,u=c?20:s,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":s=ka("markerSize",g,this)||4;u=c?20:s;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "bubble":s=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=s/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(A)||s(D)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?D+t>m&&(h+=0<a[g].labelAngle?D+t-m-Z:0):0>a[g].labelAngle?A-w<l&&A-w<a[g].viewportMinimum&&(E=l-(L+a[g].tickLength+x+A-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(D+t>m&&(h=D+t/2-m-Z),A-w<l&&A-w<a[g].viewportMinimum&&(E=l-L-a[g].tickLength-x-A+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<h?m-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?l+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(l+=E),0<h&&(m-=h))),n.panEnabled?V=s(n.sessionVariables.axisX.height)?n.sessionVariables.axisX.height=V:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=V,h=Math.round(f.y2-V-e+G),k=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+y[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:m,y2:k-(V+e-y[g]-G),width:m-l,height:k-h}),G+=y[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+Q+L),d[g].lineCoordinates.x2=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),n.panEnabled?W=s(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=W:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=W,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+W+X-R,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-z[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(W+
X-z[g]-R),x2:m,y2:k,width:m-l,height:k-h},R+=z[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)L=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+W+X<Math.max(L,p)?Math.max(L,p):f.y1+W+X),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-V-e-L),c[g].lineCoordinates={x1:l-T,y1:h,x2:m-T,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(x[g]-c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(x[g]+T),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),T+=x[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),L=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+W+X<Math.max(L,p)?Math.max(L,p):f.y1+W+X),L=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(V+e+L)),b[g].lineCoordinates=
...
a[g].valueType?2:1)].position,l=a[g].getApparentDifference(a[g].viewportMinimum,l),D=a[g].logarithmic?(1<l?Math.log(l)/a[g].conversionParameters.lnLogarithmBase*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1:(0<l?l*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1));if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateValueToPixelConversionParameters(),d[g].calculateBreaksSizeInValues(),d[g]._labels&&1<d[g]._labels.length&&(A=(d[g].logarithmic?
...
[];A=[];E=[];w=[];D=[];t=[];K=[];for(M=[];4>u;){V=U=R=T=Y=L=X=e=P=N=G=W=0;if(a&&0<a.length)for(E=[],g=U=0;g<a.length;g++)E.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),U+=E[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else E.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));K.push(E);if(d&&0<d.length)for(w=[],g=V=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),V+=w[g],X+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));M.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-V-X>n.width-10?n.width-10:f.x2-V-X),c[g].labelAutoFit&&!s(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-z/2:0===c[g].labelAngle?m-z/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-V-X>b[g].chart.width-10?b[g].chart.width-10:f.x2-V-X),b[g]&&b[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,x):0===b[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m-=C/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=T=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),T+=p[g]+c[g].margin,L+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));D.push(p);if(b&&0<b.length)for(A=[],g=R=0;g<b.length;g++)A.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),R+=A[g],Y+=b[g].margin;else A.push(Math.ceil(b[0]?
b[0].createLabelsAndCalculateHeight():0));t.push(A);if(c&&0<c.length)for(g=0;g<c.length;g++)0<c[g]._labels.length&&(k=c[g]._labels[0],h=c[g]._labels[c[g]._labels.length-1],y=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),z=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));
...
!1;else I=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)O=D[u-1][g]===D[u][g]?!0:!1;else O=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)J=t[u-1][g]===t[u][g]?!0:!1;else J=!0}if(r&&I&&O&&J)break;u++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
this.chart.renderCrosshairs(this.parent);this._hidden=!0};Z.prototype.render=function(a,d,c){var b,e,f,l,h=null,m=null,k=null,n="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var p=0,p="xySwapped"===this.chart.plotInfo.axisPlacement?50<this.parent.range?0:500<this.chart.width&&25>this.parent.range?2:Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0):50<this.parent.range?
...
"error"===n[0].dataSeries.type)for(var u=Math.abs(a-this.parent.convertValueToPixel(n[w].dataPoint.y[0])),t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(var y=0;y<n[r].dataPoint.y.length;y++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),t<u&&(u=t,w=r);else t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<u&&(u=t,w=r);else if("stackedBar"===n[0].dataSeries.type)for(var u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),z=t=
0,r=w=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),t<u&&(u=t,w=r);else z+=n[r].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(z)),t<u&&(u=t,w=r);else if("stackedBar100"===n[0].dataSeries.type)for(var u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),x=z=t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)t=
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),t<u&&(u=t,w=r);else z+=n[r].dataPoint.y,x=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,x=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[x]),t=Math.abs(a-this.parent.convertValueToPixel(x)),t<u&&(u=t,w=r);else for(u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=w=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),
t<u&&(u=t,w=r);else t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<u&&(u=t,w=r);y=n[w];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[w].type||"error"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[0]));for(r=t=0;r<y.dataPoint.y.length;r++)t=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[r])),t<u&&(u=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<
0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;this.value=y.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.y[b]}):s(this.options.label)?da(c?c:y.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));z=t=0;for(r=w;0<=r;r--)z+=n[r].dataPoint.y,t=Math.abs(a-
this.parent.convertValueToPixel(z)),t<u&&(u=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;this.value=z;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.y}):s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));
x=z=t=0;for(r=w;0<=r;r--)z+=n[r].dataPoint.y,x=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,x=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[x]),t=Math.abs(a-this.parent.convertValueToPixel(x)),t<u&&(u=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(x)<<0)+0.5:this.parent.convertValueToPixel(x)<<0;this.value=x;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x}):s(this.options.label)?da(c?
c:x,this.valueFormatString,this.chart._cultureInfo):this.label}else h=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y)<<0,this.value=y.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.y}):s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=h;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;
...
l=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};x=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])x=!0;else{x=!1;break}if(x){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),u=null,w=0;w<this.parent.dataSeries.length;w++)(u=
this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=u.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?u.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.x}):s(this.options.label)?za(c?c:y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):
this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.x}):s(this.options.label)?da(c?c:y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.y=l+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=
...
u.dataSeries.visible&&n.push(u));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});y=n[0];b=e=h=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:l};x=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])x=!0;else{x=!1;break}if(x){if("axisX"===
...
value:y.dataPoint.x}):s(this.options.label)?za(c?c:y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?da(c?c:y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-
...
r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),t<u&&(u=t,w=r);else t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<u&&(u=t,w=r);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===n[0].dataSeries.type)for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=z=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<
n[r].dataPoint.y.length;y++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),t<u&&(u=t,w=r);else z+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(z)),t<u&&(u=t,w=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=x=z=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),
t<u&&(u=t,w=r);else z+=n[r].dataPoint.y,x=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,x=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[x]),t=Math.abs(d-this.parent.convertValueToPixel(x)),t<u&&(u=t,w=r);else for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),t<u&&(u=t,w=r);else t=Math.abs(d-
this.parent.convertValueToPixel(n[r].dataPoint.y)),t<u&&(u=t,w=r);y=n[w];b=0;if("rangeColumn"===this.parent.dataSeries[w].type||"rangeArea"===this.parent.dataSeries[w].type||"error"===this.parent.dataSeries[w].type||"rangeSplineArea"===this.parent.dataSeries[w].type||"candlestick"===this.parent.dataSeries[w].type||"ohlc"===this.parent.dataSeries[w].type||"boxAndWhisker"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[0]));for(r=t=0;r<y.dataPoint.y.length;r++)t=
Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[r])),t<u&&(u=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.y[b]}):s(this.options.label)?da(c?c:y.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y.dataPoint.y[b]}else if("stackedColumn"===
this.parent.dataSeries[w].type||"stackedArea"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));z=t=0;for(r=w;0<=r;r--)z+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(z)),t<u&&(u=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.y}):s(this.options.label)?
da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=z}else if("stackedColumn100"===this.parent.dataSeries[w].type||"stackedArea100"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));z=t=0;for(r=w;0<=r;r--)z+=n[r].dataPoint.y,x=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,x=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[x]),t=Math.abs(d-this.parent.convertValueToPixel(x)),t<u&&(u=t,b=r);m=
1===q.lineWidth%2?(this.parent.convertValueToPixel(x)<<0)+0.5:this.parent.convertValueToPixel(x)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x}):s(this.options.label)?da(c?c:x,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x}else"waterfall"===this.parent.dataSeries[w].type?(m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<0)+0.5:this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<
0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataSeries.dataPointEOs[y.index].cumulativeSum}):s(this.options.label)?da(c?c:y.dataSeries.dataPointEOs[y.index].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=y.dataSeries.dataPointEOs[y.index].cumulativeSum):(m=1===q.lineWidth%2?(s(a)?d:this.parent.convertValueToPixel(y.dataPoint.y)<<0)+0.5:s(a)?d:this.parent.convertValueToPixel(y.dataPoint.y)<<
0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=y.dataPoint.y);f=l=m;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};k.y=l+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-
...
this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){x=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])x=!0;else{x=!1;break}if(x){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),u=null,w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=u.index&&
...
this.valueFormatString,this.chart._cultureInfo):this.label,k.x=b-k.measureText().width/2,k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width),k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1),"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("bottom"===this.parent._position||"top"===this.parent._position){x=!1;n="";if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])x=!0;else{x=!1;break}if(x){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),u=null,w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=u.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?c?c:u.dataPoint.label:this.label)}else"dateTime"===
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(h);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};na(X,I);X.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();x.version="v3.4.1 GA";window.CanvasJS&&(x&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=x)})();
